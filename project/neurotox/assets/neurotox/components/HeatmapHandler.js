...
class HeatmapHandler extends React.Component {
        ...
        switch (this.props.readoutType) {
            ...
            case READOUT_TYPE_CATEGORY: {
                data = _.chain(this.state.data)
                    ...
                    .map((d) => {
                        // console.log('ZW fill 1')
                        // console.log(d)
                        // console.log(fillFunction(d))
                        //ZW 10-26,
                        // I added bmd into the object, bmd: d.bmd.
                        return {
                            bmd: d.bmd,
    ...
    render() {
        ...
        console.log(d);
        console.log(d.data);
        console.log(d.legendData);
        return <Heatmap data={d.data} legendData={d.legendData} />;
    }
}
