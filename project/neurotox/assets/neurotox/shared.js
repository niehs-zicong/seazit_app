...
const AXIS_LINEAR = 1,
    ...
    URL_CHEMXLSX = '/static/resources/neurotox/NTP%20Chemical%20Library.xlsx',
    URL_METADATA = '/neurotox/api/assay/metadata/?format=json',
    URL_CONCRESPMATRIX = '/neurotox/api/readout/drs/',
    INTVIZ_OBAMA = 1,
    INTVIZ_BOXPLOT = 2,
    INTVIZ_ASSAY_PCA = 3,
