...
// ZW 5-7
import ResponseFigure from '../components/ResponseFigure';
import ResponseHandler from '../components/ResponseHandler';

// ZW

import Loading from 'utils/Loading';
import ExposureHeatmapDisplaySelector from '../widgets/ExposureHeatmapDisplaySelector';

import HelpButtonWidget from '../widgets/HelpButtonWidget';
import ExposurePlotWidget from '../widgets/ExposurePlotWidget';
...
import ExposureReadoutTypeWidget from '../widgets/ExposureReadoutTypeWidget';
import {
    BMD_HILL,
    HEATMAP_ACTIVITY,
    HEATMAP_BMC,
...
class ExposureValueMain extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            // loadMetadata
            ...
            // ExposureHeatmapDisplaySelector
            heatmapDisplay: HEATMAP_BMC,
        };
    }
    ...
    _renderReadoutChemicalSelectors() {
        ...
        return (
            <div>
                <ExposureReadoutTypeWidget stateHolder={this} />
                {widget}
                <hr />
    ...
    _renderMainBody() {
        ...
        switch (viz) {
            ...
            // ZW 5-5 . this is heatmap case, adding new plot part here,
            // ZW new plot

            // <div className="col-lg-9">
            //  <ResponseFigure chemicals={this.props.objects} showBoxplot={false} />
            // </div>

            //                        <ResponseFigure
            //                            chemicals={this.props.objects} showBoxplot={false}
            //                        />
            //                        <ResponseFigure
            //                        chemicals={[chemical]} showBoxplot={false}
            //                        />
            //                        <ResponseFigure
            //                            chemicals={this.state.chemicals} showBoxplot={false}
            //                        />

            //<ResponseFigure chemicals={this.props.objects} showBoxplot={false} />

            // test above, we should we responseFigure above.
            case INTVIZ_HEATMAP: {
                return (
                    <div>
                        <ResponseHandler
                        ...
                        />
                        <p className="help-block">
                            <b>Interactivity note:</b> heatmap case. This heatmap is interactive.
                            Click a cell to view individual dose-response curves associated with it.
                        </p>
                    </div>
                );
            }
        ...
        return (
            <div className="row-fluid">
                ...
                <div className="col-md-3">
                    <ExposurePlotWidget stateHolder={this} />
                    {isHeatmap
                        ? [
                              <hr key="0" />,
                              <ExposureHeatmapDisplaySelector key="1" stateHolder={this} />,
                          ]
                        : null}
                    <hr />
...
export default ExposureValueMain;
