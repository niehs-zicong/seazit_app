                ...
                left: function(t, e) {
                    ...
                    r < 0
                        ? ((s = t.left + h + i + a + e.collisionWidth - n - s) < 0 || s < k(r)) &&
                          (t.left += h + i + a)
                        : 0 < l &&
                          (0 < (o = t.left - e.collisionPosition.marginLeft + h + i + a - o) ||
                              k(o) < l) &&
                          (t.left += h + i + a);
                },
                top: function(t, e) {
                    ...
                    r < 0
                        ? ((s = t.top + h + i + a + e.collisionHeight - n - s) < 0 || s < k(r)) &&
                          (t.top += h + i + a)
                        : 0 < l &&
                          (0 < (o = t.top - e.collisionPosition.marginTop + h + i + a - o) ||
                              k(o) < l) &&
                          (t.top += h + i + a);
                },
            },
    ...
    function S(s) {
        ...
        return (
            ...
            w(g, function(t, e) {
                ...
                if (i)
                    return (
                        (i = n[e](i)), (n[_[e].cache] = i[_[e].cache]), (o = n._rgba = i._rgba), !1
                    );
            }),
            ...
            w(t, function(t, o) {
                (d.cssHooks[o] = {
                    ...
                    (d.fx.step[o] = function(t) {
                        t.colorInit ||
                            ((t.start = m(t.elem, o)), (t.end = m(t.end)), (t.colorInit = !0)),
    ...
    function $(t) {
        return (
            ...
            ('string' == typeof t && !V.effects.effect[t]) ||
                'function' == typeof t || ('object' == typeof t && !t.effect)
        );
    }
    function G(t, e) {
        var i = e.outerWidth(),
        ...
        return 'area' === a
            ? ((s = (i = t.parentNode).name),
              !(!t.href || !s || 'map' !== i.nodeName.toLowerCase()) &&
                  0 < (s = V("img[usemap='#" + s + "']")).length && s.is(':visible'))
                ...
                this.active
                    ? this.isLastItem() ||
                      (this._hasScroll()
                          ...
                          : this.focus(
                                t,
                                this._menuItems(this.activeMenu)[this.active ? 'last' : 'first']()
                            ))
                    : this.next(t);
            },
        ...
        V.extend(st.prototype, {
            ...
            _updateDatepicker: function(t) {
                ...
                0 < n.length && ot.apply(n.get(0)),
                    t.dpDiv
                        ...
                        .width(''),
                    1 < s &&
                        t.dpDiv.addClass('ui-datepicker-multi-' + s).css('width', 17 * s + 'em'),
            ...
            _checkOffset: function(t, e, i) {
                ...
                return (
                    ...
                    (e.left -=
                        i && e.left === t.input.offset().left ? V(document).scrollLeft() : 0),
                    (e.top -=
                        i && e.top === t.input.offset().top + a ? V(document).scrollTop() : 0),
                    (e.left -= Math.min(
                        e.left,
            ...
            drag: function(t, e, i) {
                for (
                    ...
                    (l = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width),
                        (c =
                            (h = i.snapElements[v].top - i.margins.top) + i.snapElements[v].height),
                        g < r - p ||
                        l + p < f ||
                        _ < h - p ||
                        c + p < m ||
        ...
        _create: function() {
            ...
            this._addClass('ui-resizable'),
                V.extend(this, {
                    ...
                    _helper:
                        e.helper || e.ghost || e.animate ? e.helper || 'ui-resizable-helper' : null,
                }),
            ...
            resize: function(t) {
                ...
                r[0] !== document && /static/.test(r.css('position')) && (a = s),
                    n.left < (e._helper ? s.left : 0) &&
                        ((e.size.width =
                            e.size.width +
                            (e._helper ? e.position.left - s.left : e.position.left - a.left)),
                            ...
                            ((s =
                                ...
                                (this.options.greedy &&
                                    ...
                                    (i = this.element
                                        ...
                                        .filter(function() {
                                            return (
                                                V(this).droppable('instance').options.scope === e
                                            );
                                        })).length &&
    ...
    V.ui.droppable,
        ...
        V.widget('ui.selectmenu', [
            V.ui.formResetMixin,
            {
                ...
                _appendTo: function() {
                    var t = this.options.appendTo;
                    return (t = !(t =
                        !(t = t && (t.jquery || t.nodeType ? V(t) : this.document.find(t).eq(0))) ||
                        !t[0]
                            ? this.element.closest('.ui-front, dialog')
                            : t).length
                        ? this.document[0].body
        ...
        V.widget('ui.slider', V.ui.mouse, {
            ...
            _createHandles: function() {
                ...
                for (
                    i.length > n && (i.slice(n).remove(), (i = i.slice(0, n))), t = i.length;
                    t < n;
                    t++
                )
            ...
            _mouseCapture: function(t) {
                ...
                return (
                    ...
                    this.handles.each(function(t) {
                        ...
                        (e < s ||
                            (s === e && (t === r._lastChangedValue || r.values(t) === l.min))) &&
                            ((s = e), (n = V(this)), (o = t));
                    }),
                    !1 !== this._start(t, o) &&
            ...
            _refreshValue: function() {
                ...
                this._hasMultipleValues()
                    ? this.handles.each(function(t) {
                          (i =
                              ((r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin())) *
                              100),
            ...
            serialize: function(e) {
                ...
                return (
                    ...
                    V(t).each(function() {
                        ...
                        t &&
                            i.push(
                                (e.key || t[1] + '[]') + '=' + (e.key && e.expression ? t[1] : t[2])
                            );
                    }),
