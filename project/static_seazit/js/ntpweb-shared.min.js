...
var NTP, i, addthis_config, ntpExternalDisclaimer;
(function (n, t) {
    "use strict";
    ...
    function pr(n, t, i) {
        ...
        if (u.text = n, t) for (r in re) e = t[r] || t.getAttribute && t.getAttribute(r), e && u.setAttribute(r, e);
        i.head.appendChild(u).parentNode.removeChild(u)
    }

    function rt(n) {
        return n == null ? n + "" : typeof n == "object" || typeof n == "function" ? ti[vr.call(n)] || "object" : typeof n
    }

    function ai(n) {
        var t = !!n && "length" in n && n.length, i = rt(n);
    ...
    function eu(n, t, i) {
        var r;
        if (i === undefined && n.nodeType === 1) if (r = "data-" + t.replace(he, "-$&").toLowerCase(), i = n.getAttribute(r), typeof i == "string") {
            try {
                i = ce(i)
            } catch (u) {
            }
    ...
    function au(n, t, r, u, f) {
        for (var e, o, p, a, w, v, h = t.createDocumentFragment(), y = [], l = 0, b = n.length; l < b; l++) if (e = n[l], e || e === 0) if (rt(e) === "object") i.merge(y, e.nodeType ? [e] : e); else if (lu.test(e)) {
            for (o = o || h.appendChild(t.createElement("div")), p = (hu.exec(e) || ["", ""])[1].toLowerCase(), a = c[p] || c._default, o.innerHTML = a[1] + i.htmlPrefilter(e) + a[2], v = a[0]; v--;) o = o.lastChild;
        ...
        for (h.textContent = "", l = 0; e = y[l++];) {
            ...
            if (w = ot(e), o = s(h.appendChild(e), "script"), w && wi(o), r) for (v = 0; e = o[v++];) cu.test(e.type || "") && r.push(e)
        }
        return h
    }
    ...
    function ki(n, t, r, u, f, e) {
        ...
        if (u == null && f == null ? (f = r, u = r = undefined) : f == null && (typeof r == "string" ? (f = u, u = undefined) : (f = u, u = r, r = undefined)), f === !1) f = ct; else if (!f) return n;
        ...
        i.event.add(n, t, {
            namespace: !1, handler: function (n) {
                ...
                if (n.isTrigger & 1 && this[t]) {
                    if (f.length) (i.event.special[t] || {}).delegateType && n.stopPropagation(); else if (f = k.call(arguments), r.set(this, t, f), o = u(this, t), this[t](), e = r.get(this, t), f !== e || o ? r.set(this, t, !1) : e = {}, f !== e) return n.stopImmediatePropagation(), n.preventDefault(), e && e.value
    ...
    function yu(n, t) {
        ...
        if (t.nodeType === 1) {
            if (r.hasData(n) && (h = r.get(n), u = h.events, u)) {
                ...
                for (e in u) for (f = 0, s = u[e].length; f < s; f++) i.event.add(t, e, u[e][f])
            }
    ...
    function lt(n, t, f, o) {
        ...
        if (k || p > 1 && typeof w == "string" && !e.checkClone && we.test(w)) return n.each(function (i) {
            var r = n.eq(i);
            k && (t[0] = w.call(this, i, r.html()));
            lt(r, t, f, o)
        });
        if (p && (a = au(t, n[0].ownerDocument, !1, n, o), b = a.firstChild, a.childNodes.length === 1 && (a = b), b || o)) {
            for (l = i.map(s(a, "script"), ke), v = l.length; c < p; c++) h = a, c !== d && (h = i.clone(h, !0, !0), v && i.merge(l, s(h, "script"))), f.call(n[c], h, c);
            if (v) for (y = l[l.length - 1].ownerDocument, i.map(l, de), c = 0; c < v; c++) h = l[c], cu.test(h.type || "") && !r.access(h, "globalEval") && i.contains(y, h) && (h.src && (h.type || "").toLowerCase() !== "module" ? i._evalUrl && !h.noModule && i._evalUrl(h.src, {nonce: h.nonce || h.getAttribute("nonce")}, y) : pr(h.textContent.replace(be, ""), h, y))
        }
        return n
    }

    function pu(n, t, r) {
        for (var u, e = t ? i.filter(t, n) : n, f = 0; (u = e[f]) != null; f++) r || u.nodeType !== 1 || i.cleanData(s(u)), u.parentNode && (r && ot(u) && wi(s(u, "script")), u.parentNode.removeChild(u));
        return n
    }

    function dt(n, t, r) {
        var o, s, h, u, f = n.style;
        return r = r || oi(n), r && (u = r.getPropertyValue(t) || r[t], u !== "" || ot(n) || (u = i.style(n, t)), !e.pixelBoxStyles() && di.test(u) && no.test(t) && (o = f.width, s = f.minWidth, h = f.maxWidth, f.minWidth = f.maxWidth = f.width = u, u = r.width, f.width = o, f.minWidth = s, f.maxWidth = h)), u !== undefined ? u + "" : u
    }
    ...
    function to(n) {
        for (var i = n[0].toUpperCase() + n.slice(1), t = ku.length; t--;) if (n = ku[t] + i, n in du) return n
    }

    function gi(n) {
        var t = i.cssProps[n] || gu[n];
        return t ? t : n in du ? n : gu[n] = to(n) || n
    }
    ...
    function uf(n, t, r) {
        var f = oi(n), c = !e.boxSizingReliable() || r, o = c && i.css(n, "boxSizing", !1, f) === "border-box", s = o,
            u = dt(n, t, f), h = "offset" + t[0].toUpperCase() + t.slice(1);
        if (di.test(u)) {
            if (!r) return u;
            u = "auto"
        }
        return (!e.boxSizingReliable() && o || !e.reliableTrDimensions() && l(n, "tr") || u === "auto" || !parseFloat(u) && i.css(n, "display", !1, f) === "inline") && n.getClientRects().length && (o = i.css(n, "boxSizing", !1, f) === "border-box", s = h in n, s && (u = n[h])), u = parseFloat(u) || 0, u + nr(n, t, r || (o ? "border" : "content"), s, f, u) + "px"
    }
    ...
    function tr() {
        si && (f.hidden === !1 && n.requestAnimationFrame ? n.requestAnimationFrame(tr) : n.setTimeout(tr, i.fx.interval), i.fx.tick())
    }
    ...
    function fo(n, t) {
        var r, f, e, u, o;
        for (r in n) if (f = y(r), e = t[f], u = n[r], Array.isArray(u) && (e = u[1], u = n[r] = u[0]), r !== f && (n[f] = u, delete n[r]), o = i.cssHooks[f], o && "expand" in o) {
            u = o.expand(u);
            delete n[f];
    ...
    function v(n, t, r) {
        ...
        for (fo(c, f.opts.specialEasing); h < a; h++) if (o = v.prefilters[h].call(f, n, c, f.opts), o) return u(o.stop) && (i._queueHooks(f.elem, f.opts.queue).stop = o.stop.bind(o)), o;
    ...
    function er(n, t, r, u) {
        ...
        if (Array.isArray(t)) i.each(t, function (t, i) {
            r || eo.test(n) ? u(n, i) : er(n + "[" + (typeof i == "object" && i != null ? t : "") + "]", i, r, u)
        }); else if (r || rt(t) !== "object") u(n, t); else for (f in t) er(n + "[" + f + "]", t[f], r, u)
    }
    ...
    var p = [], lr = Object.getPrototypeOf, k = p.slice, ar = p.flat ? function (n) {
            return p.flat.call(n)
        } : function (n) {
            return p.concat.apply([], n)
        }, li = p.push, ni = p.indexOf, ti = {}, vr = ti.toString, ii = ti.hasOwnProperty, yr = ii.toString,
        ie = yr.call(Object), e = {}, u = function (n) {
            return typeof n == "function" && typeof n.nodeType != "number" && typeof n.item != "function"
        }, it = function (n) {
            return n != null && n === n.window
        }, f = n.document, re = {type: !0, src: !0, nonce: !0, noModule: !0}, wr = "3.6.0", i = function (n, t) {
            return new i.fn.init(n, t)
        }, d, vi, dr, gr, nu, tu, iu, a, fu, ui, et, bt, pi, c, lu, bi, at, si, ff, ef, hf, vt, cf, lf, af, rr, ur, df, yt,
        cr, ci, gf, ne, te;
    i.fn = i.prototype = {
        jquery: wr, constructor: i, length: 0, toArray: function () {
            return k.call(this)
        }, get: function (n) {
        ...
        }, push: li, sort: p.sort, splice: p.splice
    };
    i.extend = i.fn.extend = function () {
        var s, f, e, t, o, c, n = arguments[0] || {}, r = 1, l = arguments.length, h = !1;
        for (typeof n == "boolean" && (h = n, n = arguments[r] || {}, r++), typeof n == "object" || u(n) || (n = {}), r === l && (n = this, r--); r < l; r++) if ((s = arguments[r]) != null) for (f in s) (t = s[f], f !== "__proto__" && n !== t) && (h && t && (i.isPlainObject(t) || (o = Array.isArray(t))) ? (e = n[f], c = o && !Array.isArray(e) ? [] : o || i.isPlainObject(e) ? e : {}, o = !1, n[f] = i.extend(h, c, t)) : t !== undefined && (n[f] = t));
        return n
    };
    i.extend({
        expando: "jQuery" + (wr + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (n) {
            throw new Error(n);
        }, noop: function () {
        }, isPlainObject: function (n) {
            var t, i;
            return !n || vr.call(n) !== "[object Object]" ? !1 : (t = lr(n), !t) ? !0 : (i = ii.call(t, "constructor") && t.constructor, typeof i == "function" && yr.call(i) === ie)
        }, isEmptyObject: function (n) {
            for (var t in n) return !1;
            return !0
        }, globalEval: function (n, t, i) {
            pr(n, {nonce: t && t.nonce}, i)
        }, each: function (n, t) {
            var r, i = 0;
            if (ai(n)) {
            ...
            var e, u, r = 0, f = [];
            if (ai(n)) for (e = n.length; r < e; r++) u = t(n[r], r, i), u != null && f.push(u); else for (r in n) u = t(n[r], r, i), u != null && f.push(u);
            return ar(f)
        }, guid: 1, support: e
    });
    ...
    d = function (n) {
        function u(n, t, r, u) {
            ...
            if (!u && (b(t), t = t || i, h)) {
                if (a !== 11 && (w = ar.exec(n))) if (s = w[1]) {
                    if (a === 9) if (c = t.getElementById(s)) {
                        if (c.id === s) return r.push(c), r
                    } else return r; else if (v && (c = v.getElementById(s)) && et(t, c) && c.id === s) return r.push(c), r
                } else {
        ...
        function wt(n, t, i) {
            var r = t.dir, u = t.next, f = u || r, o = i && f === "parentNode", s = nr++;
        ...
        function fi(n, t, i, r, u, f) {
            return r && !r[e] && (r = fi(r)), u && !u[e] && (u = fi(u, f)), l(function (f, e, o, s) {
                var l, c, a, p = [], y = [], w = e.length, b = f || wr(t || "*", o.nodeType ? [o] : o, []),
                    v = n && (f || !t) ? bt(b, p, n, o, s) : b, h = i ? u || (f ? n : w || r) ? [] : e : v;
        ...
        function ei(n) {
            for (var o, u, r, s = n.length, h = t.relative[n[0].type], c = h || t.relative[" "], i = h ? 1 : 0, l = wt(function (n) {
                ...
                return o = null, r
            }]; i < s; i++) if (u = t.relative[n[i].type]) f = [wt(ui(f), u)]; else {
        ...
        var rt, f, t, st, oi, ft, kt, si, ht, w, ut, b, i, s, h, o, d, ct, et, e = "sizzle" + 1 * new Date,
            c = n.document, v = 0, nr = 0, hi = yt(), ci = yt(), li = yt(), lt = yt(), dt = function (n, t) {
                return n === t && (ut = !0), 0
            ...
            vi = "\\[" + r + "*(" + tt + ")(?:" + r + "*([*^$|!~]?=)" + r + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + tt + "))|)" + r + "*\\]",
            ni = ":(" + tt + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + vi + ")*)|.*)\\)|)",
            ur = new RegExp(r + "+", "g"), at = new RegExp("^" + r + "+|((?:^|[^\\\\])(?:\\\\.)*)" + r + "+$", "g"),
            fr = new RegExp("^" + r + "*," + r + "*"), yi = new RegExp("^" + r + "*([>+~]|" + r + ")" + r + "*"),
            er = new RegExp(r + "|>"), or = new RegExp(ni), sr = new RegExp("^" + tt + "$"), vt = {
                ID: new RegExp("^#(" + tt + ")"),
                CLASS: new RegExp("^\\.(" + tt + ")"),
                TAG: new RegExp("^(" + tt + "|[*])"),
                ATTR: new RegExp("^" + vi),
            ...
            }, hr = /HTML$/i, cr = /^(?:input|select|textarea|button)$/i, lr = /^h\d$/i, ot = /^[^{]+\{\s*\[native \w/,
            ar = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ti = /[+~]/,
        ...
        t = u.selectors = {
            ...
            pseudos: {
                not: l(function (n) {
                    ...
                    return sr.test(n || "") || u.error("unsupported lang: " + n), n = n.replace(y, p).toLowerCase(), function (t) {
                        var i;
                        do if (i = h ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return i = i.toLowerCase(), i === n || i.indexOf(n + "-") === 0; while ((t = t.parentNode) && t.nodeType === 1);
                        return !1
                    }
                }), target: function (t) {
                ...
                }, enabled: di(!1), disabled: di(!0), checked: function (n) {
        ...
        return gi.prototype = t.filters = t.pseudos, t.setFilters = new gi, ft = u.tokenize = function (n, i) {
            ...
            if (r = r || [], s.length === 1) {
                if (f = s[0] = s[0].slice(0), f.length > 2 && (e = f[0]).type === "ID" && i.nodeType === 9 && h && t.relative[f[1].type]) {
                    if (i = (t.find.ID(e.matches[0].replace(y, p), i) || [])[0], i) c && (i = i.parentNode); else return r;
    ...
    i.fn.extend({
        find: function (n) {
            ...
            return !!yi(this, typeof n == "string" && kr.test(n) ? i(n) : n || [], !1).length
        }
    });
    gr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    nu = i.fn.init = function (n, t, r) {
        var e, o;
        if (!n) return this;
        if (r = r || dr, typeof n == "string") {
            if (e = n[0] === "<" && n[n.length - 1] === ">" && n.length >= 3 ? [null, n, null] : gr.exec(n), e && (e[1] || !t)) {
                if (e[1]) {
                    if (t = t instanceof i ? t[0] : t, i.merge(this, i.parseHTML(e[1], t && t.nodeType ? t.ownerDocument || t : f, !0)), vi.test(e[1]) && i.isPlainObject(t)) for (e in t) u(this[e]) ? this[e](t[e]) : this.attr(e, t[e]);
                    return this
                }
    ...
    nu.prototype = i.fn;
    dr = i(f);
    tu = /^(?:parents|prev(?:Until|All))/;
    iu = {children: !0, contents: !0, next: !0, prev: !0};
    i.fn.extend({
        has: function (n) {
            ...
            if (!kr.test(n)) for (; f < o; f++) for (r = this[f]; r && r !== t; r = r.parentNode) if (r.nodeType < 11 && (e ? e.index(r) > -1 : r.nodeType === 1 && i.find.matchesSelector(r, n))) {
                u.push(r);
                break
            }
    ...
    i.each({
        parent: function (n) {
            ...
            return ru(n, "nextSibling")
        }, prev: function (n) {
            return ru(n, "previousSibling")
        }, nextAll: function (n) {
            ...
            return br((n.parentNode || {}).firstChild, n)
        }, children: function (n) {
            return br(n.firstChild)
        }, contents: function (n) {
            return n.contentDocument != null && lr(n.contentDocument) ? n.contentDocument : (l(n, "template") && (n = n.content || n), i.merge([], n.childNodes))
        }
    }, function (n, t) {
        i.fn[n] = function (r, u) {
            var f = i.map(this, t, r);
            return n.slice(-5) !== "Until" && (u = r), u && typeof u == "string" && (f = i.filter(u, f)), this.length > 1 && (iu[n] || i.uniqueSort(f), tu.test(n) && f.reverse()), this.pushStack(f)
        }
    });
    a = /[^\x20\t\r\n\f]+/g;
    i.Callbacks = function (n) {
        ...
        var o, r, c, f, t = [], s = [], e = -1, l = function () {
            for (f = f || n.once, c = o = !0; s.length; e = -1) for (r = s.shift(); ++e < t.length;) t[e].apply(r[0], r[1]) === !1 && n.stopOnFalse && (e = t.length, r = !1);
            n.memory || (r = !1);
            o = !1;
            f && (t = r ? [] : "")
        }, h = {
            add: function () {
                ...
                return i.each(arguments, function (n, r) {
                    for (var u; (u = i.inArray(r, t, u)) > -1;) t.splice(u, 1), u <= e && e--
                }), this
            }, has: function (n) {
    ...
    i.extend({
        Deferred: function (t) {
            ...
            var e = arguments.length, t = e, o = Array(t), f = k.call(arguments), r = i.Deferred(), s = function (n) {
                return function (t) {
                    o[n] = this;
            ...
            if (e <= 1 && (uu(n, r.done(s(t)).resolve, r.reject, !e), r.state() === "pending" || u(f[t] && f[t].then))) return r.then();
            while (t--) uu(f[t], s(t), r.reject);
            return r.promise()
        }
    });
    fu = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
    i.Deferred.exceptionHook = function (t, i) {
        n.console && n.console.warn && t && fu.test(t.name) && n.console.warn("jQuery.Deferred exception: " + t.message, t.stack, i)
    };
    ...
    pt.prototype = {
        cache: function (n) {
            ...
            if (typeof t == "string") u[y(t)] = i; else for (r in t) u[y(r)] = t[r];
            return u
        }, get: function (n, t) {
            ...
            if (r !== undefined) {
                if (t !== undefined) for (Array.isArray(t) ? t = t.map(y) : (t = y(t), t = t in r ? [t] : t.match(a) || []), u = t.length; u--;) delete r[t[u]];
    ...
    var r = new pt, o = new pt, se = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, he = /[A-Z]/g;
    i.extend({
        hasData: function (n) {
        ...
        data: function (n, t) {
            ...
            if (n === undefined) {
                if (this.length && (e = o.get(i), i.nodeType === 1 && !r.get(i, "hasDataAttrs"))) {
                    for (f = s.length; f--;) s[f] && (u = s[f].name, u.indexOf("data-") === 0 && (u = y(u.slice(5)), eu(i, u, e[u])));
            ...
            return typeof n == "object" ? this.each(function () {
                ...
                var r;
                if (i && t === undefined) return (r = o.get(i, n), r !== undefined) ? r : (r = eu(i, n), r !== undefined) ? r : void 0;
                this.each(function () {
                    o.set(this, n, t)
                })
    ...
    var ou = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, wt = new RegExp("^(?:([+-])=|)(" + ou + ")([a-z%]*)$", "i"),
        b = ["Top", "Right", "Bottom", "Left"], g = f.documentElement, ot = function (n) {
    ...
    var kt = /^(?:checkbox|radio)$/i, hu = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, cu = /^$|^module$|\/(?:java|ecma)script/i;
    (function () {
        var i = f.createDocumentFragment(), n = i.appendChild(f.createElement("div")), t = f.createElement("input");
    ...
    i.event = {
        global: {}, add: function (n, t, u, f, e) {
            ...
            if (et(n)) for (u.handler && (l = u, u = l.handler, e = l.selector), e && i.find.matchesSelector(g, e), u.guid || (u.guid = i.guid++), (y = p.events) || (y = p.events = Object.create(null)), (v = p.handle) || (v = p.handle = function (t) {
                return typeof i != "undefined" && i.event.triggered !== t.type ? i.event.dispatch.apply(n, arguments) : undefined
            }), t = (t || "").match(a) || [""], b = t.length; b--;) (w = bi.exec(t[b]) || [], o = d = w[1], k = (w[2] || "").split(".").sort(), o) && (s = i.event.special[o] || {}, o = (e ? s.delegateType : s.bindType) || o, s = i.event.special[o] || {}, h = i.extend({
                type: o,
                origType: d,
                data: f,
                handler: u,
            ...
            if (w && (v = w.events)) {
                for (t = (t || "").match(a) || [""], p = t.length; p--;) {
                    if (h = bi.exec(t[p]) || [], o = d = h[1], b = (h[2] || "").split(".").sort(), !o) {
            ...
            var u, c, s, e, f, l, h = new Array(arguments.length), t = i.event.fix(n),
            ...
            if (h && r.nodeType && !(n.type === "click" && n.button >= 1)) for (; r !== this; r = r.parentNode || this) if (r.nodeType === 1 && !(n.type === "click" && r.disabled === !0)) {
    ...
    var pe = /<script|<style|<link/i, we = /checked\s*(?:[^=]|=\s*.checked.)/i,
        be = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    i.extend({
        htmlPrefilter: function (n) {
            ...
            if (!e.noCloneChecked && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n)) for (f = s(h), o = s(n), u = 0, c = o.length; u < c; u++) ge(o[u], f[u]);
            if (t) if (r) for (o = o || s(n), f = f || s(h), u = 0, c = o.length; u < c; u++) yu(o[u], f[u]); else yu(n, h);
            return f = s(h, "script"), f.length > 0 && wi(f, !l && s(n, "script")), h
        }, cleanData: function (n) {
            for (var u, t, f, s = i.event.special, e = 0; (t = n[e]) !== undefined; e++) if (et(t)) {
                if (u = t[r.expando]) {
    ...
    i.fn.extend({
        detach: function (n) {
            ...
            for (var n, t = 0; (n = this[t]) != null; t++) n.nodeType === 1 && (i.cleanData(s(n, !1)), n.textContent = "");
            return this
        }, clone: function (n, t) {
            ...
            return w(this, function (n) {
                ...
                if (typeof n == "string" && !pe.test(n) && !c[(hu.exec(n) || ["", ""])[1].toLowerCase()]) {
                    n = i.htmlPrefilter(n);
                    try {
    ...
    var di = new RegExp("^(" + ou + ")(?!px)[a-z%]+$", "i"), oi = function (t) {
    ...
    (function () {
        ...
        t.style && (t.style.backgroundClip = "content-box", t.cloneNode(!0).style.backgroundClip = "", e.clearCloneStyle = t.style.backgroundClip === "content-box", i.extend(e, {
            boxSizingReliable: function () {
                ...
                var i, t, r, u;
                return o == null && (i = f.createElement("table"), t = f.createElement("tr"), r = f.createElement("div"), i.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", t.style.cssText = "border:1px solid", t.style.height = "1px", r.style.height = "9px", r.style.display = "block", g.appendChild(i).appendChild(t).appendChild(r), u = n.getComputedStyle(t), o = parseInt(u.height, 10) + parseInt(u.borderTopWidth, 10) + parseInt(u.borderBottomWidth, 10) === t.offsetHeight, g.removeChild(i)), o
            }
        }))
    })();
    var ku = ["Webkit", "Moz", "ms"], du = f.createElement("div").style, gu = {};
    var io = /^(none|table(?!-c[ea]).+)/, nf = /^--/,
    ...
    i.extend({
        ...
        style: function (n, t, r, u) {
            if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
                ...
                if (l || (t = gi(c)), o = i.cssHooks[t] || i.cssHooks[c], r !== undefined) {
                    if (s = typeof r, s === "string" && (f = wt.exec(r)) && f[1] && (r = su(n, t, f), s = "number"), r == null || r !== r) return;
        ...
        css: function (n, t, r, u) {
            ...
            return (h || (t = gi(s)), e = i.cssHooks[t] || i.cssHooks[s], e && "get" in e && (f = e.get(n, !0, r)), f === undefined && (f = dt(n, t, u)), f === "normal" && t in tf && (f = tf[t]), r === "" || r) ? (o = parseFloat(f), r === !0 || isFinite(o) ? o || 0 : f) : f
        }
    });
    i.each(["height", "width"], function (n, t) {
        i.cssHooks[t] = {
            get: function (n, r, u) {
                if (r) return io.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? wu(n, ro, function () {
                    return uf(n, t, u)
                }) : uf(n, t, u)
            }, set: function (n, r, u) {
                var s, f = oi(n), h = !e.scrollboxSize() && f.position === "absolute", l = h || u,
                    c = l && i.css(n, "boxSizing", !1, f) === "border-box", o = u ? nr(n, t, u, c, f) : 0;
                return c && h && (o -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(f[t]) - nr(n, t, "border", !1, f) - .5)), o && (s = wt.exec(r)) && (s[3] || "px") !== "px" && (n.style[t] = r, r = i.css(n, t)), rf(n, r, o)
            }
        }
    });
    i.cssHooks.marginLeft = bu(e.reliableMarginLeft, function (n, t) {
        if (t) return (parseFloat(dt(n, "marginLeft")) || n.getBoundingClientRect().left - wu(n, {marginLeft: 0}, function () {
    ...
    h.propHooks = {
        _default: {
            get: function (n) {
                ...
                i.fx.step[n.prop] ? i.fx.step[n.prop](n) : n.elem.nodeType === 1 && (i.cssHooks[n.prop] || n.elem.style[gi(n.prop)] != null) ? i.style(n.elem, n.prop, n.now + n.unit) : n.elem[n.prop] = n.now
            }
        }
    };
    ...
    i.fn.extend({
        fadeTo: function (n, t, i, r) {
            ...
            return typeof n != "string" && (u = t, t = n, n = undefined), t && this.queue(n || "fx", []), this.each(function () {
                ...
                if (t) e[t] && e[t].stop && f(e[t]); else for (t in e) e[t] && e[t].stop && ef.test(t) && f(e[t]);
    ...
    i.fn.delay = function (t, r) {
        ...
        var n = f.createElement("input"), t = f.createElement("select"), i = t.appendChild(f.createElement("option"));
        n.type = "checkbox";
        e.checkOn = n.value !== "";
    ...
    i.fn.extend({
        addClass: function (n) {
            ...
            if (f = ir(n), f.length) while (r = this[c++]) if (e = tt(r), t = r.nodeType === 1 && " " + nt(e) + " ", t) {
            ...
            if (f = ir(n), f.length) while (r = this[c++]) if (e = tt(r), t = r.nodeType === 1 && " " + nt(e) + " ", t) {
                for (h = 0; o = f[h++];) while (t.indexOf(" " + o + " ") > -1) t = t.replace(" " + o + " ", " ");
                s = nt(t);
                e !== s && r.setAttribute("class", s)
            }
            return this
        }, toggleClass: function (n, t) {
            var f = typeof n, e = f === "string" || Array.isArray(n);
            return typeof t == "boolean" && e ? t ? this.addClass(n) : this.removeClass(n) : u(n) ? this.each(function (r) {
                ...
                var t, o, u, s;
                if (e) for (o = 0, u = i(this), s = ir(n); t = s[o++];) u.hasClass(t) ? u.removeClass(t) : u.addClass(t); else (n === undefined || f === "boolean") && (t = tt(this), t && r.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || n === !1 ? "" : r.get(this, "__className__") || ""))
            })
        }, hasClass: function (n) {
            for (var t, r = 0, i = " " + n + " "; t = this[r++];) if (t.nodeType === 1 && (" " + nt(tt(t)) + " ").indexOf(i) > -1) return !0;
            return !1
        }
    });
    af = /\r/g;
    ...
    i.extend({
        valHooks: {
            option: {
                ...
                get: function (n) {
                    for (var e, t, o = n.options, u = n.selectedIndex, f = n.type === "select-one", s = f ? null : [], h = f ? u + 1 : o.length, r = u < 0 ? h : f ? u : 0; r < h; r++) if (t = o[r], (t.selected || r === u) && !t.disabled && (!t.parentNode.disabled || !l(t.parentNode, "optgroup"))) {
    ...
    i.extend(i.event, {
        trigger: function (t, e, o, s) {
            var k, c, l, d, v, y, a, w, b = [o || f], h = ii.call(t, "type") ? t.type : t,
                p = ii.call(t, "namespace") ? t.namespace.split(".") : [];
            if ((c = w = l = o = o || f, o.nodeType !== 3 && o.nodeType !== 8) && !rr.test(h + i.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), v = h.indexOf(":") < 0 && "on" + h, t = t[i.expando] ? t : new i.Event(h, typeof t == "object" && t), t.isTrigger = s ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = undefined, t.target || (t.target = o), e = e == null ? [t] : i.makeArray(e, [t]), a = i.event.special[h] || {}, s || !a.trigger || a.trigger.apply(o, e) !== !1)) {
                if (!s && !a.noBubble && !it(o)) {
                    for (d = a.delegateType || h, rr.test(d + h) || (c = c.parentNode); c; c = c.parentNode) b.push(c), l = c;
                    l === (o.ownerDocument || f) && b.push(l.defaultView || l.parentWindow || n)
                }
                for (k = 0; (c = b[k++]) && !t.isPropagationStopped();) w = c, t.type = k > 1 ? d : a.bindType || h, y = (r.get(c, "events") || Object.create(null))[t.type] && r.get(c, "handle"), y && y.apply(c, e), y = v && c[v], y && y.apply && et(c) && (t.result = y.apply(c, e), t.result === !1 && t.preventDefault());
                return t.type = h, s || t.isDefaultPrevented() || (!a._default || a._default.apply(b.pop(), e) === !1) && et(o) && v && u(o[h]) && !it(o) && (l = o[v], l && (o[v] = null), i.event.triggered = h, t.isPropagationStopped() && w.addEventListener(h, ur), o[h](), t.isPropagationStopped() && w.removeEventListener(h, ur), i.event.triggered = undefined, l && (o[v] = l)), t.result
            }
    ...
    e.focusin || i.each({focus: "focusin", blur: "focusout"}, function (n, t) {
        ...
        i.event.special[t] = {
            setup: function () {
                var i = this.ownerDocument || this.document || this, f = r.access(i, t);
                f || i.addEventListener(n, u, !0);
                r.access(i, t, (f || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this.document || this, f = r.access(i, t) - 1;
                f ? r.access(i, t, f) : (i.removeEventListener(n, u, !0), r.remove(i, t))
            }
        }
    });
    var gt = n.location, vf = {guid: Date.now()}, fr = /\?/;
    ...
    var eo = /\[\]$/, yf = /\r?\n/g, oo = /^(?:submit|button|image|reset|file)$/i,
    ...
    i.fn.extend({
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var n = this.type;
                return this.name && !i(this).is(":disabled") && so.test(this.nodeName) && !oo.test(n) && (this.checked || !kt.test(n))
            }).map(function (n, t) {
                var r = i(this).val();
    ...
    var ho = /%20/g, co = /#.*$/, lo = /([?&])_=[^&]*/, ao = /^(.*?):[ \t]*([^\r\n]*)$/mg, vo = /^(?:GET|HEAD)$/,
        yo = /^\/\//, pf = {}, or = {}, wf = "*/".concat("*"), sr = f.createElement("a");
    return sr.href = gt.href, i.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajaxSetup: function (n, t) {
            return t ? hr(hr(n, i.ajaxSettings), t) : hr(i.ajaxSettings, n)
        },
        ajaxPrefilter: bf(pf),
        ajaxTransport: bf(or),
        ajax: function (t, r) {
            function b(t, r, f, l) {
                var v, rt, g, p, b, a = r;
                s || (s = !0, d && n.clearTimeout(d), c = undefined, k = l || "", e.readyState = t > 0 ? 4 : 0, v = t >= 200 && t < 300 || t === 304, f && (p = po(u, e, f)), !v && i.inArray("script", u.dataTypes) > -1 && i.inArray("json", u.dataTypes) < 0 && (u.converters["text script"] = function () {
                }), p = wo(u, p, e, v), v ? (u.ifModified && (b = e.getResponseHeader("Last-Modified"), b && (i.lastModified[o] = b), b = e.getResponseHeader("etag"), b && (i.etag[o] = b)), t === 204 || u.type === "HEAD" ? a = "nocontent" : t === 304 ? a = "notmodified" : (a = p.state, rt = p.data, g = p.error, v = !g)) : (g = a, (t || !a) && (a = "error", t < 0 && (t = 0))), e.status = t, e.statusText = (r || a) + "", v ? tt.resolveWith(h, [rt, a, e]) : tt.rejectWith(h, [e, a, g]), e.statusCode(w), w = undefined, y && nt.trigger(v ? "ajaxSuccess" : "ajaxError", [e, u, v ? rt : g]), it.fireWith(h, [e, a]), y && (nt.trigger("ajaxComplete", [e, u]), --i.active || i.event.trigger("ajaxStop")))
            }

            typeof t == "object" && (r = t, t = undefined);
            r = r || {};
            var c, o, k, v, d, l, s, y, g, p, u = i.ajaxSetup({}, r), h = u.context || u,
                ...
                it = i.Callbacks("once memory"), w = u.statusCode || {}, rt = {}, ut = {}, ft = "canceled", e = {
                    readyState: 0, getResponseHeader: function (n) {
                        var t;
                        if (s) {
                            if (!v) for (v = {}; t = ao.exec(k);) v[t[1].toLowerCase() + " "] = (v[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = v[n.toLowerCase() + " "]
                        }
            ...
            if (tt.promise(e), u.url = ((t || u.url || gt.href) + "").replace(yo, gt.protocol + "//"), u.type = r.method || r.type || u.method || u.type, u.dataTypes = (u.dataType || "*").toLowerCase().match(a) || [""], u.crossDomain == null) {
                l = f.createElement("a");
                try {
                    l.href = u.url;
                    l.href = l.href;
                    u.crossDomain = sr.protocol + "//" + sr.host != l.protocol + "//" + l.host
                } catch (et) {
                    u.crossDomain = !0
                }
            }
            ...
            o = u.url.replace(co, "");
            u.hasContent ? u.data && u.processData && (u.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (u.data = u.data.replace(ho, "+")) : (p = u.url.slice(o.length), u.data && (u.processData || typeof u.data == "string") && (o += (fr.test(o) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (o = o.replace(lo, "$1"), p = (fr.test(o) ? "&" : "?") + "_=" + vf.guid++ + p), u.url = o + p);
            ...
            if (ft = "abort", it.add(u.complete), e.done(u.success), e.fail(u.error), c = kf(or, u, r, e), c) {
        ...
        jsonp: "callback", jsonpCallback: function () {
            var n = cr.pop() || i.expando + "_" + vf.guid++;
            return this[n] = !0, n
        }
    }), i.ajaxPrefilter("json jsonp", function (t, r, f) {
        var e, o, s,
            h = t.jsonp !== !1 && (ci.test(t.url) ? "url" : typeof t.data == "string" && (t.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && ci.test(t.data) && "data");
        if (h || t.dataTypes[0] === "jsonp") return e = t.jsonpCallback = u(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, h ? t[h] = t[h].replace(ci, "$1" + e) : t.jsonp !== !1 && (t.url += (fr.test(t.url) ? "&" : "?") + t.jsonp + "=" + e), t.converters["script json"] = function () {
            return s || i.error(e + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = n[e], n[e] = function () {
            s = arguments
        }, f.always(function () {
            o === undefined ? i(n).removeProp(e) : n[e] = o;
            t[e] && (t.jsonpCallback = r.jsonpCallback, cr.push(e));
            s && u(o) && o(s[0]);
            s = o = undefined
        }), "script"
        ...
        var s, u, o;
        return (t || (e.createHTMLDocument ? (t = f.implementation.createHTMLDocument(""), s = t.createElement("base"), s.href = f.location.href, t.head.appendChild(s)) : t = f), u = vi.exec(n), o = !r && [], u) ? [t.createElement(u[1])] : (u = au([n], t, o), o && o.length && i(o).remove(), i.merge([], u.childNodes))
        ...
        offset: function (n) {
            ...
            if (this[0]) {
                var n, u, f, t = this[0], r = {top: 0, left: 0};
                if (i.css(t, "position") === "fixed") u = t.getBoundingClientRect(); else {
        ...
        i.cssHooks[t] = bu(e.pixelPosition, function (n, r) {
            if (r) return r = dt(n, t), di.test(r) ? i(n).position()[t] + "px" : r
        })
    ...
    typeof exports == "object" && typeof module == "object" ? module.exports = t(require("jquery")) : typeof define == "function" && define.amd ? define(["jquery"], t) : typeof exports == "object" ? exports["foundation.core"] = t(require("jquery")) : (n.__FOUNDATION_EXTERNAL__ = n.__FOUNDATION_EXTERNAL__ || {}, n.__FOUNDATION_EXTERNAL__["foundation.core"] = t(n.jQuery))
}(window, function (n) {
    return function (n) {
        function t(r) {
        ...
        return t.m = n, t.c = i, t.d = function (n, i, r) {
            ...
            if (r = Object.create(null), t.r(r), Object.defineProperty(r, "default", {
                enumerable: !0,
                value: n
            }), i & 2 && typeof n != "string") for (u in n) t.d(r, u, function (t) {
                return n[t]
            }.bind(null, u));
            return r
        }, t.n = function (n) {
        ...
        "./js/entries/plugins/foundation.core.js": function (n, t, i) {
            "use strict";
            var f, r;
            i.r(t);
            var e = i("jquery"), o = i.n(e), u = i("./js/foundation.core.js");
            i.d(t, "Foundation", function () {
                return u.Foundation
            });
            f = i("./js/foundation.core.plugin.js");
            ...
            i.d(t, "GetYoDigits", function () {
                return r.GetYoDigits
            });
            i.d(t, "RegExpEscape", function () {
                return r.RegExpEscape
            });
            i.d(t, "transitionend", function () {
                return r.transitionend
            });
            i.d(t, "onLoad", function () {
                return r.onLoad
            });
            i.d(t, "ignoreMousedisappear", function () {
                return r.ignoreMousedisappear
            });
            u.Foundation.addToJquery(o.a);
            u.Foundation.Plugin = f.Plugin;
            u.Foundation.rtl = r.rtl;
            u.Foundation.GetYoDigits = r.GetYoDigits;
            u.Foundation.transitionend = r.transitionend;
            u.Foundation.RegExpEscape = r.RegExpEscape;
            u.Foundation.onLoad = r.onLoad;
            window.Foundation = u.Foundation
        }, "./js/foundation.core.js": function (n, t, i) {
            "use strict";
            ...
            function e(n) {
                if (typeof Function.prototype.name == "undefined") {
                    var t = /function\s([^(]{1,})\(/.exec(n.toString());
                    return t && t.length > 1 ? t[1].trim() : ""
                }
                return typeof n.prototype == "undefined" ? n.constructor.name : n.prototype.constructor.name
            }

            function a(n) {
                return "true" === n ? !0 : "false" === n ? !1 : isNaN(n * 1) ? n : parseFloat(n)
            }
            ...
            var h = i("jquery"), r = i.n(h), c = i("./js/foundation.core.utils.js"),
                l = i("./js/foundation.util.mediaQuery.js");
            s = "6.7.4";
            f = {
                version: s, _plugins: {}, _uuids: [], plugin: function (n, t) {
                    var i = t || e(n), r = o(i);
                    this._plugins[r] = this[i] = n
                }, registerPlugin: function (n, t) {
                    var i = t ? o(t) : e(n.constructor).toLowerCase();
                    n.uuid = Object(c.GetYoDigits)(6, i);
                    n.$element.attr("data-".concat(i)) || n.$element.attr("data-".concat(i), n.uuid);
                    n.$element.data("zfPlugin") || n.$element.data("zfPlugin", n);
                    n.$element.trigger("init.zf.".concat(i));
                    this._uuids.push(n.uuid);
                    return
                }, unregisterPlugin: function (n) {
                    var i = o(e(n.$element.data("zfPlugin").constructor)), t;
                    this._uuids.splice(this._uuids.indexOf(n.uuid), 1);
                    n.$element.removeAttr("data-".concat(i)).removeData("zfPlugin").trigger("destroyed.zf.".concat(i));
                    for (t in n) typeof n[t] == "function" && (n[t] = null);
                    return
                }, reInit: function (n) {
                    var t = n instanceof r.a;
                    try {
                        if (t) n.each(function () {
                    ...
                    typeof t == "undefined" ? t = Object.keys(this._plugins) : typeof t == "string" && (t = [t]);
                    var i = this;
                    r.a.each(t, function (t, u) {
                        var f = i._plugins[u],
                            e = r()(n).find("[data-" + u + "]").addBack("[data-" + u + "]").filter(function () {
                                return typeof r()(this).data("zfPlugin") == "undefined"
                            });
                        e.each(function () {
                            var n = r()(this), t = {reflow: !0};
                            n.attr("data-options") && n.attr("data-options").split(";").forEach(function (n) {
                                var i = n.split(":").map(function (n) {
                                    return n.trim()
                                });
                                i[0] && (t[i[0]] = a(i[1]))
                            });
                            try {
                                n.data("zfPlugin", new f(r()(this), t))
                            } catch (i) {
                                console.error(i)
                            } finally {
                                return
                ...
                }, getFnName: e, addToJquery: function () {
                    var n = function (n) {
                        var i = u(n), s = r()(".no-js"), o, t;
                        if (s.length && s.removeClass("no-js"), i === "undefined") l.MediaQuery._init(), f.reflow(this); else if (i === "string") if (o = Array.prototype.slice.call(arguments, 1), t = this.data("zfPlugin"), typeof t != "undefined" && typeof t[n] != "undefined") this.length === 1 ? t[n].apply(t, o) : this.each(function (i, u) {
                            t[n].apply(r()(u).data("zfPlugin"), o)
                        }); else throw new ReferenceError("We're sorry, '" + n + "' is not an available method for " + (t ? e(t) : "this element") + "."); else throw new TypeError("We're sorry, ".concat(i, " is not a valid parameter. You must use a string representing the method you wish to invoke."));
                        return this
                    };
                    return r.a.fn.foundation = n, r.a
                }
            };
            f.util = {
            ...
            window.Foundation = f, function () {
                var i, n, t, r;
                for (Date.now && window.Date.now || (window.Date.now = Date.now = function () {
                    return (new Date).getTime()
                }), i = ["webkit", "moz"], n = 0; n < i.length && !window.requestAnimationFrame; ++n) t = i[n], window.requestAnimationFrame = window[t + "RequestAnimationFrame"], window.cancelAnimationFrame = window[t + "CancelAnimationFrame"] || window[t + "CancelRequestAnimationFrame"];
                !/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) && window.requestAnimationFrame && window.cancelAnimationFrame || (r = 0, window.requestAnimationFrame = function (n) {
                    var t = Date.now(), i = Math.max(r + 16, t);
            ...
            Function.prototype.bind || (Function.prototype.bind = function (n) {
                ...
                var r = Array.prototype.slice.call(arguments, 1), u = this, t = function () {
                }, i = function () {
        ...
        }, "./js/foundation.core.plugin.js": function (n, t, i) {
            "use strict";
            ...
            function s(n, t, i) {
                return t && u(n.prototype, t), i && u(n, i), n
            }
            ...
            f = function () {
                function n(t, i) {
                    ...
                    this._setup(t, i);
                    var u = e(this);
                    this.uuid = Object(r.GetYoDigits)(6, u);
                    this.$element.attr("data-".concat(u)) || this.$element.attr("data-".concat(u), this.uuid);
                    this.$element.data("zfPlugin") || this.$element.data("zfPlugin", this);
                    this.$element.trigger("init.zf.".concat(u))
                }
                ...
                return s(n, [{
                    key: "destroy", value: function () {
                        ...
                        this._destroy();
                        n = e(this);
                        this.$element.removeAttr("data-".concat(n)).removeData("zfPlugin").trigger("destroyed.zf.".concat(n));
                        for (t in this) this.hasOwnProperty(t) && (this[t] = null)
                    }
                }]), n
            }()
        }, "./js/foundation.core.utils.js": function (n, t, i) {
            "use strict";

            function f() {
                return r()("html").attr("dir") === "rtl"
            }

            function e() {
                for (var u = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 6, t = arguments.length > 1 ? arguments[1] : undefined, n = "", i = "0123456789abcdefghijklmnopqrstuvwxyz", f = i.length, r = 0; r < u; r++) n += i[Math.floor(Math.random() * f)];
            ...
            function s(n) {
                ...
                }, u = document.createElement("div"), t;
                for (var r in i) typeof u.style[r] != "undefined" && (t = i[r]);
                return t ? t : (setTimeout(function () {
                    n.triggerHandler("transitionend", [n])
                }, 1), "transitionend")
            }

            function h(n, t) {
                var u = document.readyState === "complete", i = (u ? "_didLoad" : "load") + ".zf.util.onLoad",
                    f = function () {
                        return n.triggerHandler(i)
                    };
                if (n) {
                    if (t) n.one(i, t);
                    if (u) setTimeout(f); else r()(window).one("load", f)
                }
                return i
            }

            function c(n) {
                var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}, i = t.ignoreLeaveWindow,
                    f = i === void 0 ? !1 : i, u = t.ignoreReappear, e = u === void 0 ? !1 : u;
                return function (t) {
                    for (var u, o = arguments.length, s = new Array(o > 1 ? o - 1 : 0), i = 1; i < o; i++) s[i - 1] = arguments[i];
                    if (u = n.bind.apply(n, [this, t].concat(s)), t.relatedTarget !== null) return u();
                    setTimeout(function () {
                        if (!f && document.hasFocus && !document.hasFocus()) return u();
                        if (!e) r()(document).one("mouseenter", function (n) {
                            r()(t.currentTarget).has(n.target).length || (t.relatedTarget = n.target, u())
                        })
                    }, 0)
                }
            }
            ...
            var u = i("jquery"), r = i.n(u)
        }, "./js/foundation.util.mediaQuery.js": function (n, t, i) {
            "use strict";
            ...
            function c(n, t) {
                if (n) {
                    ...
                    return (i === "Object" && n.constructor && (i = n.constructor.name), i === "Map" || i === "Set") ? Array.from(n) : i === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? e(n, t) : void 0
                }
            }
            ...
            function l(n, t) {
                ...
                if (i != null) {
                    var r = [], u = !0, f = !1, e, o;
                    try {
                        for (i = i.call(n); !(u = (e = i.next()).done); u = !0) if (r.push(e.value), t && r.length === t) break
                    } catch (s) {
                        f = !0;
                        o = s
                    } finally {
            ...
            function v(n) {
                var t = {};
                return typeof n != "string" ? t : (n = n.trim().slice(1, -1), !n) ? t : n.split("&").reduce(function (n, t) {
                    var u = t.replace(/\+/g, " ").split("="), i = u[0], r = u[1];
                    return i = decodeURIComponent(i), r = typeof r == "undefined" ? null : decodeURIComponent(r), n.hasOwnProperty(i) ? Array.isArray(n[i]) ? n[i].push(r) : n[i] = [n[i], r] : n[i] = r, n
                }, {})
            }
            ...
            window.matchMedia || (window.matchMedia = function () {
                ...
                if (!t) {
                    var n = document.createElement("style"), i = document.getElementsByTagName("script")[0], r = null;
                    n.type = "text/css";
                    n.id = "matchmediajs-test";
                    i ? i.parentNode.insertBefore(n, i) : document.head.appendChild(n);
                    r = "getComputedStyle" in window && window.getComputedStyle(n, null) || n.currentStyle;
                    t = {
                        matchMedium: function (t) {
                            var i = "@media " + t + "{ #matchmediajs-test { width: 1px; } }";
                            return n.styleSheet ? n.styleSheet.cssText = i : n.textContent = i, r.width === "1px"
                        }
                    }
                }
                return function (n) {
                    return {matches: t.matchMedium(n || "all"), media: n || "all"}
                }
            }());
            o = {
                queries: [], current: "", _init: function () {
                    var i, u, f, n, t;
                    if (this.isInitialized === !0) return this;
                    this.isInitialized = !0;
                    i = this;
                    u = r()("meta.foundation-mq");
                    u.length || r()('<meta class="foundation-mq" name="foundation-mq" content>').appendTo(document.head);
                    f = r()(".foundation-mq").css("font-family");
                    n = v(f);
                    i.queries = [];
                    for (t in n) n.hasOwnProperty(t) && i.queries.push({
                        name: t,
                        value: "only screen and (min-width: ".concat(n[t], ")")
                    });
                    ...
                    return n === this._getCurrentSize()
                }, upTo: function (n) {
                    var t = this.next(n);
                    return t ? !this.atLeast(t) : !0
                }, is: function (n) {
                    var f = n.trim().split(" ").filter(function (n) {
                        return !!n.length
                    }), r = s(f, 2), i = r[0], u = r[1], t = u === void 0 ? "" : u;
                    if (t === "only") return this.only(i);
                    if (!t || t === "up") return this.atLeast(i);
                    if (t === "down") return this.upTo(i);
                    throw new Error('\n      Invalid breakpoint passed to MediaQuery.is().\n      Expected a breakpoint name formatted like "<size> <modifier>", got "'.concat(n, '".\n    '));
                }, get: function (n) {
                    var t, i;
                    for (t in this.queries) if (this.queries.hasOwnProperty(t) && (i = this.queries[t], n === i.name)) return i.value;
                    return null
                }, next: function (n) {
                    var r = this, i = this.queries.findIndex(function (t) {
                        return r._getQueryName(t) === n
                    }), t;
                    if (i === -1) throw new Error('\n        Unknown breakpoint "'.concat(n, '" passed to MediaQuery.next().\n        Ensure it is present in your Sass "$breakpoints" setting.\n      '));
                    return t = this.queries[i + 1], t ? t.name : null
                }, _getQueryName: function (n) {
                    if (typeof n == "string") return n;
                    if (u(n) === "object") return n.name;
                    throw new TypeError('\n      Invalid value passed to MediaQuery._getQueryName().\n      Expected a breakpoint name (String) or a breakpoint query (Object), got "'.concat(n, '" (').concat(u(n), ")\n    "));
                }, _getCurrentSize: function () {
                    for (var i, n, t = 0; t < this.queries.length; t++) i = this.queries[t], window.matchMedia(i.value).matches && (n = i);
                    return n && this._getQueryName(n)
                }, _watcher: function () {
                    var n = this;
                    r()(window).on("resize.zf.trigger", function () {
                        var t = n._getCurrentSize(), i = n.current;
                        t !== i && (n.current = t, r()(window).trigger("changed.zf.mediaquery", [t, i]))
                    })
                }
            }
        }, 0: function (n, t, i) {
            n.exports = i("./js/entries/plugins/foundation.core.js")
        }, jquery: function (t) {
            t.exports = n
        }
    })
    ...
    return function (n) {
        ...
        "./foundation.core": function (t) {
            t.exports = n
        }, "./js/entries/plugins/foundation.util.mediaQuery.js": function (n, t, i) {
            "use strict";
            var r, f, u;
            i.r(t);
            r = i("./foundation.core");
            ...
            r.Foundation.MediaQuery = u.MediaQuery;
            r.Foundation.MediaQuery._init()
        }, "./js/foundation.util.mediaQuery.js": function (n, t, i) {
            "use strict";
            ...
            n.exports = i("./js/entries/plugins/foundation.util.mediaQuery.js")
        }, jquery: function (n) {
            n.exports = t
        }
    })
...
for (function (n) {
    ...
    function tt() {
        ...
        this.dpDiv = it(n("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'><\/div>"))
    }
    ...
    function rt() {
        n.datepicker._isDisabledDatepicker(f.inline ? f.dpDiv.parent()[0] : f.input[0]) || (n(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), n(this).addClass("ui-state-hover"), this.className.indexOf("ui-datepicker-prev") !== -1 && n(this).addClass("ui-datepicker-prev-hover"), this.className.indexOf("ui-datepicker-next") !== -1 && n(this).addClass("ui-datepicker-next-hover"))
    }
    ...
    function s(n) {
        return n == null ? n + "" : typeof n == "object" ? v[rr.call(n)] || "object" : typeof n
    }
    ...
    var st, lt, at, vt, yt, wt, bt, kt, d, g, dt, gt, ni, ti, ii, ri, o, ui, fi, ei, oi, si, hi, ci, li, nt, ai, vi, yi,
        f, wi, bi, ki, di, gi, nr, tr, ir, i, er, or, sr, hr, cr, lr, ar, vr, yr, pr, wr, br, kr, dr, b, gr;
    n.ui = n.ui || {};
    st = n.ui.version = "1.13.1";
    /*!
 ...
 */
    var ht = 0, ct = Array.prototype.hasOwnProperty, k = Array.prototype.slice;
    n.cleanData = function (t) {
        return function (i) {
            for (var r, u, f = 0; (u = i[f]) != null; f++) r = n._data(u, "events"), r && r.remove && n(u).triggerHandler("remove");
            t(i)
        }
    }(n.cleanData);
    ...
    n.widget.extend = function (t) {
        for (var f = k.call(arguments, 1), u = 0, e = f.length, i, r; u < e; u++) for (i in f[u]) r = f[u][i], ct.call(f[u], i) && r !== undefined && (t[i] = n.isPlainObject(r) ? n.isPlainObject(t[i]) ? n.widget.extend({}, t[i], r) : n.widget.extend({}, r) : r);
        return t
    };
    n.widget.bridge = function (t, i) {
        var r = i.prototype.widgetFullName || t;
        n.fn[t] = function (u) {
            var o = typeof u == "string", e = k.call(arguments, 1), f = this;
    ...
    n.Widget.prototype = {
        ...
        _classes: function (t) {
            function f() {
                ...
                i._on(n(r), {remove: "_untrackClassesElement"})
            }
    ...
    n.each({show: "fadeIn", hide: "fadeOut"}, function (t, i) {
        n.Widget.prototype["_" + t] = function (r, u, f) {
            ...
            u = u || {};
            typeof u == "number" ? u = {duration: u} : u === !0 && (u = {});
            o = !n.isEmptyObject(u);
            u.complete = f;
 ...
 */
    (function () {
        ...
        var u, i = Math.max, t = Math.abs, f = /left|center|right/, e = /top|center|bottom/,
            o = /[\+\-]\d+(\.[\d]+)?%?/, s = /^\w+/, h = /%$/, a = n.fn.position;
        n.position = {
            scrollbarWidth: function () {
                if (u !== undefined) return u;
                var r, i,
                    t = n("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'><\/div><\/div>"),
                    f = t.children()[0];
                ...
                var i = n(t || window), r = l(i[0]), u = !!i[0] && i[0].nodeType === 9, f = !r && !u;
                return {
                    element: i,
                    isWindow: r,
                    isDocument: u,
        ...
        n.fn.position = function (u) {
            ...
            u = n.extend({}, u);
            var w, h, l, p, y, k, d = typeof u.of == "string" ? n(document).find(u.of) : n(u.of),
                nt = n.position.getWithinInfo(u.within), tt = n.position.getScrollInfo(nt),
                b = (u.collision || "flip").split(" "), g = {};
            return k = v(d), d[0].preventDefault && (u.at = "left top"), h = k.width, l = k.height, p = k.offset, y = n.extend({}, p), n.each(["my", "at"], function () {
            ...
            }), b.length === 1 && (b[1] = b[0]), u.at[0] === "right" ? y.left += h : u.at[0] === "center" && (y.left += h / 2), u.at[1] === "bottom" ? y.top += l : u.at[1] === "center" && (y.top += l / 2), w = c(g.at, h, l), y.left += w[0], y.top += w[1], this.each(function () {
                var v, k, e = n(this), o = e.outerWidth(), s = e.outerHeight(), it = r(this, "marginLeft"),
                    rt = r(this, "marginTop"), ut = o + it + r(this, "marginRight") + tt.width,
                    ft = s + rt + r(this, "marginBottom") + tt.height, f = n.extend({}, y),
                    a = c(g.my, e.outerWidth(), e.outerHeight());
                u.my[0] === "right" ? f.left -= o : u.my[0] === "center" && (f.left -= o / 2);
                u.my[1] === "bottom" ? f.top -= s : u.my[1] === "center" && (f.top -= s / 2);
                f.left += a[0];
                f.top += a[1];
                v = {marginLeft: it, marginTop: rt};
                ...
                u.using && (k = function (n) {
                    var r = p.left - f.left, v = r + h - o, c = p.top - f.top, y = c + l - s, a = {
                        target: {element: d, left: p.left, top: p.top, width: h, height: l},
 ...
 */
    n.ui.focusable = function (t, i) {
        ...
        return "area" === s ? (u = t.parentNode, f = u.name, !t.href || !f || u.nodeName.toLowerCase() !== "map") ? !1 : (e = n("img[usemap='#" + f + "']"), e.length > 0 && e.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(s) ? (r = !t.disabled, r && (o = n(t).closest("fieldset")[0], o && (r = !o.disabled))) : r = "a" === s ? t.href || i : i, r && n(t).is(":visible") && pt(n(t)))
    };
 ...
 */
    ...
    n.escapeSelector || (d = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, g = function (n, t) {
        return t ? n === "\0" ? "�" : n.slice(0, -1) + "\\" + n.charCodeAt(n.length - 1).toString(16) + " " : "\\" + n
 ...
 * http://jquery.org/license
 */
    gt = n.fn.labels = function () {
        var t, r, u, i, f;
        return this.length ? this[0].labels && this[0].labels.length ? this.pushStack(this[0].labels) : (i = this.eq(0).parents("label"), u = this.attr("id"), u && (t = this.eq(0).parents().last(), f = t.add(t.length ? t.siblings() : this.siblings()), r = "label[for='" + n.escapeSelector(u) + "']", i = i.add(f.find(r).addBack(r))), this.pushStack(i)) : this.pushStack([])
    };
    /*!
 ...
 * http://jquery.org/license
 */
    ni = n.fn.scrollParent = function (t) {
 ...
 * http://jquery.org/license
 */
    ti = n.extend(n.expr.pseudos, {
        tabbable: function (t) {
            var i = n.attr(t, "tabindex"), r = i != null;
 ...
 */
    ...
    ri = n.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
    /*!
 ...
 */
    ...
    }, iu = n.ui.safeActiveElement = function (n) {
        var t;
        try {
            t = n.activeElement
        } catch (i) {
 ...
 */
    n.widget("ui.draggable", n.ui.mouse, {
        ...
        _mouseStop: function (t) {
            var r = this, i = !1;
            return n.ui.ddmanager && !this.options.dropBehaviour && (i = n.ui.ddmanager.drop(this, t)), this.dropped && (i = this.dropped, this.dropped = !1), this.options.revert === "invalid" && !i || this.options.revert === "valid" && i || this.options.revert === !0 || typeof this.options.revert == "function" && this.options.revert.call(this.element, i) ? n(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function () {
        ...
        _createHelper: function (t) {
            var r = this.options, u = typeof r.helper == "function",
        ...
        _adjustOffsetFromHelper: function (n) {
            ...
            Array.isArray(n) && (n = {left: +n[0], top: +n[1] || 0});
    ...
    n.widget("ui.droppable", {
        ...
        _create: function () {
            ...
            this.proportions = function () {
                if (arguments.length) n = arguments[0]; else return n ? n : n = {
        ...
        _setOption: function (t, i) {
            if (t === "accept") this.accept = typeof i == "function" ? i : function (n) {
                return n.is(i)
            }; else if (t === "scope") {
    ...
    n.widget("ui.resizable", n.ui.mouse, {
        ...
        _setupHandles: function () {
            ...
            if (this.handles = u.handles || (n(".ui-resizable-handle", this.element).length ? {
                ...
                ne: ".ui-resizable-ne",
                nw: ".ui-resizable-nw"
            } : "e,s,se"), this._handles = n(), this._addedHandles = n(), this.handles.constructor === String) for (this.handles === "all" && (this.handles = "n,e,s,w,se,sw,ne,nw"), f = this.handles.split(","), this.handles = {}, r = 0; r < f.length; r++) i = String.prototype.trim.call(f[r]), o = "ui-resizable-" + i, t = n("<div>"), this._addClass(t, "ui-resizable-handle " + o), t.css({zIndex: u.zIndex}), this.handles[i] = ".ui-resizable-" + i, this.element.children(this.handles[i]).length || (this.element.append(t), this._addedHandles = this._addedHandles.add(t));
        ...
        _respectSize: function (n) {
            var t = this._vBoundaries, i = this.axis, r = this._isNumber(n.width) && t.maxWidth && t.maxWidth < n.width,
                ...
                s = this.originalPosition.top + this.originalSize.height, h = /sw|nw|w/.test(i), c = /nw|ne|n/.test(i);
        ...
        _renderProxy: function () {
            ...
            this._helper ? (this.helper = this.helper || n("<div><\/div>").css({overflow: "hidden"}), this._addClass(this.helper, this._helper), this.helper.css({
                width: this.element.outerWidth(),
                height: this.element.outerHeight(),
                position: "absolute",
    ...
    n.ui.plugin.add("resizable", "grid", {
        resize: function () {
            var h, t = n(this).resizable("instance"), i = t.options, y = t.size, o = t.originalSize,
                s = t.originalPosition, c = t.axis, l = typeof i.grid == "number" ? [i.grid, i.grid] : i.grid,
 ...
 * http://jquery.org/license
 */
    si = n.widget("ui.sortable", n.ui.mouse, {
        version: "1.13.1",
        ...
        _mouseStart: function (t, i, r) {
            ...
            if (this.currentContainer = this, this.refreshPositions(), this.appendTo = n(u.appendTo !== "parent" ? u.appendTo : this.currentItem.parent()), this.helper = this._createHelper(t), this._cacheHelperProportions(), this._cacheMargins(), this.offset = this.currentItem.offset(), this.offset = {
                top: this.offset.top - this.margins.top,
                left: this.offset.left - this.margins.left
            }, n.extend(this.offset, {
                click: {left: t.pageX - this.offset.left, top: t.pageY - this.offset.top},
                relative: this._getRelativeOffset()
            }), this.helper.css("position", "absolute"), this.cssPosition = this.helper.css("position"), u.cursorAt && this._adjustOffsetFromHelper(u.cursorAt), this.domPosition = {
        ...
        _scroll: function (n) {
            var t = this.options, i = !1;
            return this.scrollParent[0] !== this.document[0] && this.scrollParent[0].tagName !== "HTML" ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - n.pageY < t.scrollSensitivity ? this.scrollParent[0].scrollTop = i = this.scrollParent[0].scrollTop + t.scrollSpeed : n.pageY - this.overflowOffset.top < t.scrollSensitivity && (this.scrollParent[0].scrollTop = i = this.scrollParent[0].scrollTop - t.scrollSpeed), this.overflowOffset.left + this.scrollParent[0].offsetWidth - n.pageX < t.scrollSensitivity ? this.scrollParent[0].scrollLeft = i = this.scrollParent[0].scrollLeft + t.scrollSpeed : n.pageX - this.overflowOffset.left < t.scrollSensitivity && (this.scrollParent[0].scrollLeft = i = this.scrollParent[0].scrollLeft - t.scrollSpeed)) : (n.pageY - this.document.scrollTop() < t.scrollSensitivity ? i = this.document.scrollTop(this.document.scrollTop() - t.scrollSpeed) : this.window.height() - (n.pageY - this.document.scrollTop()) < t.scrollSensitivity && (i = this.document.scrollTop(this.document.scrollTop() + t.scrollSpeed)), n.pageX - this.document.scrollLeft() < t.scrollSensitivity ? i = this.document.scrollLeft(this.document.scrollLeft() - t.scrollSpeed) : this.window.width() - (n.pageX - this.document.scrollLeft()) < t.scrollSensitivity && (i = this.document.scrollLeft(this.document.scrollLeft() + t.scrollSpeed))), i
        },
        _mouseDrag: function (t) {
            var u, i, r, f, e = this.options;
            for (this.position = this._generatePosition(t), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && this.options.axis === "y" || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && this.options.axis === "x" || (this.helper[0].style.top = this.position.top + "px"), e.scroll && this._scroll(t) !== !1 && (this._refreshItemPositions(!0), n.ui.ddmanager && !e.dropBehaviour && n.ui.ddmanager.prepareOffsets(this, t)), this.dragDirection = {
                vertical: this._getDragVerticalDirection(),
                horizontal: this._getDragHorizontalDirection()
            }, u = this.items.length - 1; u >= 0; u--) if ((i = this.items[u], r = i.item[0], f = this._intersectsWithPointer(i), f) && i.instance === this.currentContainer && r !== this.currentItem[0] && this.placeholder[f === 1 ? "next" : "prev"]()[0] !== r && !n.contains(this.placeholder[0], r) && (this.options.type === "semi-dynamic" ? !n.contains(this.element[0], r) : !0)) {
                if (this.direction = f === 1 ? "down" : "up", this.options.tolerance === "pointer" || this._intersectsWithSides(i)) this._rearrange(t, i); else break;
        ...
        _intersectsWithPointer: function (n) {
            var t, i,
                ...
                f = r && u;
            return f ? (t = this.dragDirection.vertical, i = this.dragDirection.horizontal, this.floating ? i === "right" || t === "down" ? 2 : 1 : t && (t === "down" ? 2 : 1)) : !1
        },
        _intersectsWithSides: function (n) {
            var r = this._isOverAxis(this.positionAbs.top + this.offset.click.top, n.top + n.height / 2, n.height),
                ...
                t = this.dragDirection.vertical, i = this.dragDirection.horizontal;
        ...
        _getItemsAsjQuery: function (t) {
            ...
            if (o && t) for (r = o.length - 1; r >= 0; r--) for (e = n(o[r], this.document[0]), u = e.length - 1; u >= 0; u--) i = n.data(e[u], this.widgetFullName), i && i !== this && !i.options.disabled && f.push([typeof i.options.items == "function" ? i.options.items.call(i.element) : n(i.options.items, i.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), i]);
        ...
        _refreshItems: function (t) {
            ...
            var r, u, e, i, o, s, h, l, a = this.items,
                f = [[typeof this.options.items == "function" ? this.options.items.call(this.element[0], t, {item: this.currentItem}) : n(this.options.items, this.element), this]],
                c = this._connectWith();
            if (c && this.ready) for (r = c.length - 1; r >= 0; r--) for (e = n(c[r], this.document[0]), u = e.length - 1; u >= 0; u--) i = n.data(e[u], this.widgetFullName), i && i !== this && !i.options.disabled && (f.push([typeof i.options.items == "function" ? i.options.items.call(i.element[0], t, {item: this.currentItem}) : n(i.options.items, i.element), i]), this.containers.push(i));
        ...
        _refreshItemPositions: function (t) {
            for (var i, u, f, r = this.items.length - 1; r >= 0; r--) (i = this.items[r], this.currentContainer && i.instance !== this.currentContainer && i.item[0] !== this.currentItem[0]) || (u = this.options.toleranceElement ? n(this.options.toleranceElement, i.item) : i.item, t || (i.width = u.outerWidth(), i.height = u.outerHeight()), f = u.offset(), i.left = f.left, i.top = f.top)
        },
        refreshPositions: function (n) {
            ...
            var t, i;
            if (this.options.custom && this.options.custom.refreshContainers) this.options.custom.refreshContainers.call(this); else for (t = this.containers.length - 1; t >= 0; t--) i = this.containers[t].element.offset(), this.containers[t].containerCache.left = i.left, this.containers[t].containerCache.top = i.top, this.containers[t].containerCache.width = this.containers[t].element.outerWidth(), this.containers[t].containerCache.height = this.containers[t].element.outerHeight();
            return this
        },
        _createPlaceholder: function (t) {
            t = t || this;
            var u, r, i = t.options;
            i.placeholder && i.placeholder.constructor !== String || (u = i.placeholder, r = t.currentItem[0].nodeName.toLowerCase(), i.placeholder = {
                element: function () {
                    var i = n("<" + r + ">", t.document[0]);
                    return t._addClass(i, "ui-sortable-placeholder", u || t.currentItem[0].className)._removeClass(i, "ui-sortable-helper"), r === "tbody" ? t._createTrPlaceholder(t.currentItem.find("tr").eq(0), n("<tr>", t.document[0]).appendTo(i)) : r === "tr" ? t._createTrPlaceholder(t.currentItem, i) : r === "img" && i.attr("src", t.currentItem.attr("src")), u || i.css("visibility", "hidden"), i
                }, update: function (n, f) {
                    (!u || i.forcePlaceholderSize) && ((!f.height() || i.forcePlaceholderSize && (r === "tbody" || r === "tr")) && f.height(t.currentItem.innerHeight() - parseInt(t.currentItem.css("paddingTop") || 0, 10) - parseInt(t.currentItem.css("paddingBottom") || 0, 10)), f.width() || f.width(t.currentItem.innerWidth() - parseInt(t.currentItem.css("paddingLeft") || 0, 10) - parseInt(t.currentItem.css("paddingRight") || 0, 10)))
                }
            });
        ...
        _createHelper: function (t) {
            ...
            return i.parents("body").length || this.appendTo[0].appendChild(i[0]), i[0] === this.currentItem[0] && (this._storedCSS = {
 ...
 */
    hi = n.widget("ui.accordion", {
        ...
        _eventHandler: function (t) {
            var e, o, i = this.options, u = this.active, r = n(t.currentTarget), f = r[0] === u[0],
                s = f && i.collapsible, c = s ? n() : r.next(), l = u.next(),
 ...
 */
    n.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this._initSource();
            this.menu = n("<ul>").appendTo(this._appendTo()).menu({role: null}).hide().attr({unselectable: "on"}).menu("instance");
 ...
 */
    ...
    ai = n.widget("ui.controlgroup", {
        ...
        _initWidgets: function () {
            ...
            n.each(this.options.items, function (r, u) {
                ...
                if (u) {
                    ...
                    n.fn[r] && (e = t["_" + r + "Options"] ? t["_" + r + "Options"]("middle") : {classes: {}}, t.element.find(u).each(function () {
        ...
        _buildSimpleOptions: function (n, t) {
            var i = this.options.direction === "vertical", r = {classes: {}};
            return r.classes[t] = {
                middle: "",
        ...
        _resolveClassesValues: function (t, i) {
            ...
            return n.each(t, function (n) {
                ...
                u = String.prototype.trim.call(u.replace(nt, ""));
 ...
 */
    n.widget("ui.button", {
        ...
        _updateIcon: function (t, i) {
            var u = t !== "iconPosition", r = u ? this.options.iconPosition : i, f = r === "top" || r === "bottom";
        ...
        _setOption: function (n, t) {
            ...
            this._super(n, t);
            n === "disabled" && (this._toggleClass(null, "ui-state-disabled", t), this.element[0].disabled = t, t && this.element.trigger("blur"))
        },
        refresh: function () {
    ...
    n.uiBackCompat !== !1 && (n.widget("ui.button", n.ui.button, {
        ...
        return function (i) {
            var f = typeof i == "string", u = Array.prototype.slice.call(arguments, 1), r = this;
            return f ? this.length || i !== "instance" ? this.each(function () {
                var t, e = n(this).attr("type"), o = e !== "checkbox" && e !== "radio" ? "button" : "checkboxradio",
                    f = n.data(this, "ui-" + o);
                return i === "instance" ? (r = f, !1) : f ? typeof f[i] != "function" || i.charAt(0) === "_" ? n.error("no such method '" + i + "' for button widget instance") : (t = f[i].apply(f, u), t !== f && t !== undefined ? (r = t && t.jquery ? r.pushStack(t.get()) : t, !1) : void 0) : n.error("cannot call methods on button prior to initialization; attempted to call method '" + i + "'")
            }) : r = undefined : (u.length && (i = n.widget.extend.apply(null, [i].concat(u))), this.each(function () {
                var u = n(this).attr("type"), f = u !== "checkbox" && u !== "radio" ? "button" : "checkboxradio",
                    r = n.data(this, "ui-" + f);
                if (r) r.option(i || {}), r._init && r._init(); else {
                    if (f === "button") {
                        t.call(n(this), i);
                        return
                    }
                    n(this).checkboxradio(n.extend({icon: !1}, i))
                }
            })), r
        }
    }(n.fn.button), n.fn.buttonset = function () {
        return (n.ui.controlgroup || n.error("Controlgroup widget missing"), arguments[0] === "option" && arguments[1] === "items" && arguments[2]) ? this.controlgroup.apply(this, [arguments[0], "items.button", arguments[2]]) : arguments[0] === "option" && arguments[1] === "items" ? this.controlgroup.apply(this, [arguments[0], "items.button"]) : (typeof arguments[0] == "object" && arguments[0].items && (arguments[0].items = {button: arguments[0].items}), this.controlgroup.apply(this, arguments))
    });
    yi = n.ui.button;
    /*!
 ...
 * http://jquery.org/license
 */
    n.extend(n.ui, {datepicker: {version: "1.13.1"}});
    n.extend(tt.prototype, {
        ...
        setDefaults: function (n) {
            return h(this._defaults, n || {}), this
        },
        ...
        _newInst: function (t, i) {
            ...
            return {
                ...
                drawYear: 0,
                inline: i,
                dpDiv: i ? it(n("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'><\/div>")) : this.dpDiv
            }
        },
        ...
        _attachments: function (t, i) {
            ...
            if (i.append && i.append.remove(), e && (i.append = n("<span>").addClass(this._appendClass).text(e), t[o ? "before" : "after"](i.append)), t.off("focus", this._showDatepicker), i.trigger && i.trigger.remove(), u = this._get(i, "showOn"), u === "focus" || u === "both") t.on("focus", this._showDatepicker);
            if (u === "button" || u === "both") {
                ...
                this._get(i, "buttonImageOnly") ? i.trigger = n("<img>").addClass(this._triggerClass).attr({
                    ...
                    alt: r,
                    title: r
                }) : (i.trigger = n("<button type='button'>").addClass(this._triggerClass), f ? i.trigger.html(n("<img>").attr({
                    src: f,
                    alt: r,
                    title: r
                })) : i.trigger.text(r));
        ...
        _dialogDatepicker: function (t, i, r, u, f) {
            var o, s, c, l, a, e = this._dialogInst;
            if (!e) {
                this.uuid += 1;
                o = "dp" + this.uuid;
        ...
        _optionDatepicker: function (t, i, r) {
            ...
            f = i || {};
            typeof i == "string" && (f = {}, f[i] = r);
            u && (this._curInst === u && this._hideDatepicker(), s = this._getDateDatepicker(t, !0), e = this._getMinMaxDate(u, "min"), o = this._getMinMaxDate(u, "max"), h(u.settings, f), e !== null && f.dateFormat !== undefined && f.minDate === undefined && (u.settings.minDate = this._formatDate(u, e)), o !== null && f.dateFormat !== undefined && f.maxDate === undefined && (u.settings.maxDate = this._formatDate(u, o)), "disabled" in f && (f.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)), this._attachments(n(t), u), this._autoSize(u), this._setDate(u, s), this._updateAlternate(u), this._updateDatepicker(u))
        },
        ...
        _showDatepicker: function (t) {
            if (t = t.target || t, t.nodeName.toLowerCase() !== "input" && (t = n("input", t.parentNode)[0]), !n.datepicker._isDisabledDatepicker(t) && n.datepicker._lastInput !== t) {
                var i, e, o, r, u, f, s;
                (i = n.datepicker._getInst(t), n.datepicker._curInst && n.datepicker._curInst !== i && (n.datepicker._curInst.dpDiv.stop(!0, !0), i && n.datepicker._datepickerShowing && n.datepicker._hideDatepicker(n.datepicker._curInst.input[0])), e = n.datepicker._get(i, "beforeShow"), o = e ? e.apply(t, [t, i]) : {}, o !== !1) && (h(i.settings, o), i.lastVal = null, n.datepicker._lastInput = t, n.datepicker._setDateFromField(i), n.datepicker._inDialog && (t.value = ""), n.datepicker._pos || (n.datepicker._pos = n.datepicker._findPos(t), n.datepicker._pos[1] += t.offsetHeight), r = !1, n(t).parents().each(function () {
                    ...
                    display: "block",
                    top: "-1000px"
                }), n.datepicker._updateDatepicker(i), u = n.datepicker._checkOffset(i, u, r), i.dpDiv.css({
                    position: n.datepicker._inDialog && n.blockUI ? "static" : r ? "fixed" : "absolute",
                    display: "none",
                    left: u.left + "px",
                    top: u.top + "px"
                }), i.inline || (f = n.datepicker._get(i, "showAnim"), s = n.datepicker._get(i, "duration"), i.dpDiv.css("z-index", pi(n(t)) + 1), n.datepicker._datepickerShowing = !0, n.effects && n.effects.effect[f] ? i.dpDiv.show(f, n.datepicker._get(i, "showOptions"), s) : i.dpDiv[f || "show"](f ? s : null), n.datepicker._shouldFocusInput(i) && i.input.trigger("focus"), n.datepicker._curInst = i))
            }
        },
        _updateDatepicker: function (t) {
            ...
            var i, r = this._getNumberOfMonths(t), u = r[1], e = t.dpDiv.find("." + this._dayOverClass + " a"),
                o = n.datepicker._get(t, "onUpdateDatepicker");
            e.length > 0 && rt.apply(e.get(0));
        ...
        _findPos: function (t) {
            for (var i, r = this._getInst(t), u = this._get(r, "isRTL"); t && (t.type === "hidden" || t.nodeType !== 1 || n.expr.pseudos.hidden(t));) t = t[u ? "previousSibling" : "nextSibling"];
        ...
        _adjustDate: function (t, i, r) {
            var u = n(t), f = this._getInst(u[0]);
            this._isDisabledDatepicker(u[0]) || (this._adjustInstDate(f, i, r), this._updateDatepicker(f))
        },
        ...
        _selectDay: function (t, i, r, u) {
            var f, e = n(t);
            n(u).hasClass(this._unselectableClass) || this._isDisabledDatepicker(e[0]) || (f = this._getInst(e[0]), f.selectedDay = f.currentDay = parseInt(n("a", u).attr("data-date")), f.selectedMonth = f.currentMonth = i, f.selectedYear = f.currentYear = r, this._selectDate(t, this._formatDate(f, f.currentDay, f.currentMonth, f.currentYear)))
        },
        ...
        _updateAlternate: function (t) {
            ...
            f && (i = this._get(t, "altFormat") || this._get(t, "dateFormat"), r = this._getDate(t), u = this.formatDate(i, r, this._getFormatConfig(t)), n(document).find(f).val(u))
        },
        ...
        _generateHTML: function (t) {
            var k, h, et, c, ot, d, st, nt, ht, l, ct, fi, ei, oi, si, lt, tt, hi, at, it, s, p, vt, w, yt, a, f, pt,
                wt, bt, kt, rt, dt, i, gt, ni, g, v, ut, ti = new Date,
                ii = this._daylightSavingAdjust(new Date(ti.getFullYear(), ti.getMonth(), ti.getDate())),
                e = this._get(t, "isRTL"), ai = this._get(t, "showButtonPanel"), ci = this._get(t, "hideIfNoPrevNext"),
                ri = this._get(t, "navigationAsDateFormat"), o = this._getNumberOfMonths(t),
                vi = this._get(t, "showCurrentAtPos"), li = this._get(t, "stepMonths"), ui = o[0] !== 1 || o[1] !== 1,
                ft = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) : new Date(9999, 9, 9)),
                b = this._getMinMaxDate(t, "min"), y = this._getMinMaxDate(t, "max"), r = t.drawMonth - vi,
                u = t.drawYear;
            if (r < 0 && (r += 12, u--), y) for (k = this._daylightSavingAdjust(new Date(y.getFullYear(), y.getMonth() - o[0] * o[1] + 1, y.getDate())), k = b && k < b ? b : k; this._daylightSavingAdjust(new Date(u, r, 1)) > k;) r--, r < 0 && (r = 11, u--);
            for (t.drawMonth = r, t.drawYear = u, h = this._get(t, "prevText"), h = ri ? this.formatDate(h, this._daylightSavingAdjust(new Date(u, r - li, 1)), this._getFormatConfig(t)) : h, et = this._canAdjustMonth(t, -1, u, r) ? n("<a>").attr({
                ...
                title: h
            }).append(n("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (e ? "e" : "w")).text(h))[0].outerHTML, c = this._get(t, "nextText"), c = ri ? this.formatDate(c, this._daylightSavingAdjust(new Date(u, r + li, 1)), this._getFormatConfig(t)) : c, ot = this._canAdjustMonth(t, 1, u, r) ? n("<a>").attr({
                ...
                title: c
            }).append(n("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (e ? "w" : "e")).text(c))[0].outerHTML, d = this._get(t, "currentText"), st = this._get(t, "gotoCurrent") && t.currentDay ? ft : ii, d = ri ? this.formatDate(d, st, this._getFormatConfig(t)) : d, nt = "", t.inline || (nt = n("<button>").attr({
                type: "button",
                "class": "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all",
                "data-handler": "hide",
                "data-event": "click"
            }).text(this._get(t, "closeText"))[0].outerHTML), ht = "", ai && (ht = n("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(e ? nt : "").append(this._isInRange(t, st) ? n("<button>").attr({
                type: "button",
                "class": "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all",
                "data-handler": "today",
                "data-event": "click"
            }).text(d) : "").append(e ? "" : nt)[0].outerHTML), l = parseInt(this._get(t, "firstDay"), 10), l = isNaN(l) ? 0 : l, ct = this._get(t, "showWeek"), fi = this._get(t, "dayNames"), ei = this._get(t, "dayNamesMin"), oi = this._get(t, "monthNames"), si = this._get(t, "monthNamesShort"), lt = this._get(t, "beforeShowDay"), tt = this._get(t, "showOtherMonths"), hi = this._get(t, "selectOtherMonths"), at = this._getDefaultDate(t), it = "", p = 0; p < o[0]; p++) {
                for (vt = "", this.maxRows = 4, w = 0; w < o[1]; w++) {
                    if (yt = this._daylightSavingAdjust(new Date(u, r, t.selectedDay)), a = " ui-corner-all", f = "", ui) {
                    ...
                    for (f += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + a + "'>" + (/all|left/.test(a) && p === 0 ? e ? ot : et : "") + (/all|right/.test(a) && p === 0 ? e ? et : ot : "") + this._generateMonthYearHeader(t, r, u, b, y, p > 0 || w > 0, oi, si) + "<\/div><table class='ui-datepicker-calendar'><thead><tr>", pt = ct ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "<\/th>" : "", s = 0; s < 7; s++) wt = (s + l) % 7, pt += "<th scope='col'" + ((s + l + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + fi[wt] + "'>" + ei[wt] + "<\/span><\/th>";
                    for (f += pt + "<\/tr><\/thead><tbody>", bt = this._getDaysInMonth(u, r), u === t.selectedYear && r === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, bt)), kt = (this._getFirstDayOfMonth(u, r) - l + 7) % 7, rt = Math.ceil((kt + bt) / 7), dt = ui ? this.maxRows > rt ? this.maxRows : rt : rt, this.maxRows = dt, i = this._daylightSavingAdjust(new Date(u, r, 1 - kt)), gt = 0; gt < dt; gt++) {
                        for (f += "<tr>", ni = ct ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(i) + "<\/td>" : "", s = 0; s < 7; s++) g = lt ? lt.apply(t.input ? t.input[0] : null, [i]) : [!0, ""], v = i.getMonth() !== r, ut = v && !hi || !g[0] || b && i < b || y && i > y, ni += "<td class='" + ((s + l + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (v ? " ui-datepicker-other-month" : "") + (i.getTime() === yt.getTime() && r === t.selectedMonth && t._keyEvent || at.getTime() === i.getTime() && at.getTime() === yt.getTime() ? " " + this._dayOverClass : "") + (ut ? " " + this._unselectableClass + " ui-state-disabled" : "") + (v && !tt ? "" : " " + g[1] + (i.getTime() === ft.getTime() ? " " + this._currentClass : "") + (i.getTime() === ii.getTime() ? " ui-datepicker-today" : "")) + "'" + ((!v || tt) && g[2] ? " title='" + g[2].replace(/'/g, "&#39;") + "'" : "") + (ut ? "" : " data-handler='selectDay' data-event='click' data-month='" + i.getMonth() + "' data-year='" + i.getFullYear() + "'") + ">" + (v && !tt ? "&#xa0;" : ut ? "<span class='ui-state-default'>" + i.getDate() + "<\/span>" : "<a class='ui-state-default" + (i.getTime() === ii.getTime() ? " ui-state-highlight" : "") + (i.getTime() === ft.getTime() ? " ui-state-active" : "") + (v ? " ui-priority-secondary" : "") + "' href='#' aria-current='" + (i.getTime() === ft.getTime() ? "true" : "false") + "' data-date='" + i.getDate() + "'>" + i.getDate() + "<\/a>") + "<\/td>", i.setDate(i.getDate() + 1), i = this._daylightSavingAdjust(i);
                        f += ni + "<\/tr>"
                    }
                    r++;
                    r > 11 && (r = 0, u++);
            ...
            return it += ht, t._keyEvent = !1, it
        },
        _generateMonthYearHeader: function (n, t, i, r, u, f, e, o) {
            var k, d, h, v, y, p, s, a, w = this._get(n, "changeMonth"), b = this._get(n, "changeYear"),
                g = this._get(n, "showMonthAfterYear"), nt = this._get(n, "selectMonthLabel"),
                tt = this._get(n, "selectYearLabel"), c = "<div class='ui-datepicker-title'>", l = "";
            if (f || !w) l += "<span class='ui-datepicker-month'>" + e[t] + "<\/span>"; else {
                for (k = r && r.getFullYear() === i, d = u && u.getFullYear() === i, l += "<select class='ui-datepicker-month' aria-label='" + nt + "' data-handler='selectMonth' data-event='change'>", h = 0; h < 12; h++) (!k || h >= r.getMonth()) && (!d || h <= u.getMonth()) && (l += "<option value='" + h + "'" + (h === t ? " selected='selected'" : "") + ">" + o[h] + "<\/option>");
                l += "<\/select>"
            }
            if (g || (c += l + (f || !(w && b) ? "&#xa0;" : "")), !n.yearshtml) if (n.yearshtml = "", f || !b) c += "<span class='ui-datepicker-year'>" + i + "<\/span>"; else {
                for (v = this._get(n, "yearRange").split(":"), y = (new Date).getFullYear(), p = function (n) {
                    ...
                    return isNaN(t) ? y : t
                }, s = p(v[0]), a = Math.max(s, p(v[1] || "")), s = r ? Math.max(s, r.getFullYear()) : s, a = u ? Math.min(a, u.getFullYear()) : a, n.yearshtml += "<select class='ui-datepicker-year' aria-label='" + tt + "' data-handler='selectYear' data-event='change'>"; s <= a; s++) n.yearshtml += "<option value='" + s + "'" + (s === i ? " selected='selected'" : "") + ">" + s + "<\/option>";
                n.yearshtml += "<\/select>";
                c += n.yearshtml;
                n.yearshtml = null
            }
        ...
        _adjustInstDate: function (n, t, i) {
            var u = n.selectedYear + (i === "Y" ? t : 0), f = n.selectedMonth + (i === "M" ? t : 0),
 ...
 */
    n.widget("ui.dialog", {
            ...
            this._on(this.uiDialog, {
                keydown: function (t) {
                    ...
                    if (t.keyCode === n.ui.keyCode.TAB && !t.isDefaultPrevented()) {
                        var i = this.uiDialog.find(":tabbable"), r = i.first(), u = i.last();
        ...
        _createButtons: function () {
            ...
            if (this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), n.isEmptyObject(t) || Array.isArray(t) && !t.length) {
                this._removeClass(this.uiDialog, "ui-dialog-buttons");
                return
            }
            n.each(t, function (t, r) {
                var u, f;
                r = typeof r == "function" ? {click: r, text: t} : r;
        ...
        _createOverlay: function () {
            if (this.options.modal) {
                var t = n.fn.jquery.substring(0, 4), i = !0;
                if (this._delay(function () {
                    i = !1
                }), !this.document.data("ui-dialog-overlays")) this.document.on("focusin.ui-dialog", function (n) {
                    if (!i) {
                        var r = this._trackingInstances()[0];
                        r._allowInteraction(n) || (n.preventDefault(), r._focusTabbable(), (t === "3.4." || t === "3.5.") && r._delay(r._restoreTabbableFocus))
                    }
                }.bind(this));
        ...
        _destroyOverlay: function () {
            if (this.options.modal && this.overlay) {
                ...
                n ? this.document.data("ui-dialog-overlays", n) : (this.document.off("focusin.ui-dialog"), this.document.removeData("ui-dialog-overlays"));
                this.overlay.remove();
                this.overlay = null
            }
        }
 ...
 * http://jquery.org/license
 */
    di = n.widget("ui.selectmenu", [n.ui.formResetMixin, {
        version: "1.13.1",
 ...
 * http://jquery.org/license
 */
    gi = n.widget("ui.slider", n.ui.mouse, {
        version: "1.13.1",
        ...
        _createRange: function () {
            var t = this.options;
            t.range ? (t.range === !0 && (t.values ? t.values.length && t.values.length !== 2 ? t.values = [t.values[0], t.values[0]] : Array.isArray(t.values) && (t.values = t.values.slice(0)) : t.values = [this._valueMin(), this._valueMin()]), this.range && this.range.length ? (this._removeClass(this.range, "ui-slider-range-min ui-slider-range-max"), this.range.css({
                left: "",
                bottom: ""
        ...
        values: function (n, t) {
            ...
            if (arguments.length) if (Array.isArray(arguments[0])) {
                for (r = this.options.values, u = arguments[0], i = 0; i < r.length; i += 1) r[i] = this._trimAlignValue(u[i]), this._change(null, i);
                this._refreshValue()
            } else return this._hasMultipleValues() ? this._values(n) : this.value(); else return this._values()
        },
        _setOption: function (n, t) {
            var i, r = 0;
            n === "range" && this.options.range === !0 && (t === "min" ? (this.options.value = this._values(0), this.options.values = null) : t === "max" && (this.options.value = this._values(this.options.values.length - 1), this.options.values = null));
        ...
        _refreshValue: function () {
            ...
            this._hasMultipleValues() ? this.handles.each(function (f) {
                ...
                s = t
            }) : (c = this.value(), f = this._valueMin(), h = this._valueMax(), t = h !== f ? (c - f) / (h - f) * 100 : 0, o[this.orientation === "horizontal" ? "left" : "bottom"] = t + "%", this.handle.stop(1, 1)[u ? "animate" : "css"](o, i.animate), e === "min" && this.orientation === "horizontal" && this.range.stop(1, 1)[u ? "animate" : "css"]({width: t + "%"}, i.animate), e === "max" && this.orientation === "horizontal" && this.range.stop(1, 1)[u ? "animate" : "css"]({width: 100 - t + "%"}, i.animate), e === "min" && this.orientation === "vertical" && this.range.stop(1, 1)[u ? "animate" : "css"]({height: t + "%"}, i.animate), e === "max" && this.orientation === "vertical" && this.range.stop(1, 1)[u ? "animate" : "css"]({height: 100 - t + "%"}, i.animate))
        },
        _handleEvents: {
            keydown: function (t) {
    ...
    n.widget("ui.spinner", {
        ...
        _events: {
            keydown: function (n) {
                ...
                var r = n.ui.safeActiveElement(this.document[0]), u = this.element[0] === r;
                if (u && i) {
 ...
 */
    n.widget("ui.tabs", {
        ...
        _setOptionDisabled: function (t) {
            var i, u, r;
            for (Array.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1), r = 0; u = this.tabs[r]; r++) i = n(u), t === !0 || n.inArray(r, t) !== -1 ? (i.attr("aria-disabled", "true"), this._addClass(i, null, "ui-state-disabled")) : (i.removeAttr("aria-disabled"), this._removeClass(i, null, "ui-state-disabled"));
        ...
        _getIndex: function (t) {
            return typeof t == "string" && (t = this.anchors.index(this.anchors.filter("[href$='" + n.escapeSelector(t) + "']"))), t
        },
        _destroy: function () {
        ...
        enable: function (t) {
            ...
            i !== !1 && (t === undefined ? i = !1 : (t = this._getIndex(t), i = Array.isArray(i) ? n.map(i, function (n) {
                return n !== t ? n : null
        ...
        load: function (t, i) {
            t = this._getIndex(t);
            var r = this, u = this.tabs.eq(t), e = u.find(".ui-tabs-anchor"), f = this._getPanelForTab(u),
                o = {tab: u, panel: f}, s = function (n, t) {
 ...
 */
    var v = {}, rr = v.toString, ur = /^([\-+])=\s*(\d+\.?\d*)/, fr = [{
            ...
            re: /#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?/, parse: function (n) {
                return [parseInt(n[1], 16), parseInt(n[2], 16), parseInt(n[3], 16), n[4] ? (parseInt(n[4], 16) / 255).toFixed(2) : 1]
            }
        }, {
            re: /#([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?/, parse: function (n) {
        ...
        }, ut = {byte: {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, ft = t.support = {},
        et = i("<p>")[0], c, r = i.each;
    et.style.cssText = "background-color:rgba(1,1,1,.5)";
    ft.rgba = et.style.backgroundColor.indexOf("rgba") > -1;
    r(u, function (n, t) {
        t.cache = "_" + n;
    ...
    t.fn = i.extend(t.prototype, {
        parse: function (n, f, e, o) {
            if (n === undefined) return this._rgba = [null, null, null, null], this;
            (n.jquery || n.nodeType) && (n = i(n).css(f), f = undefined);
            var h = this, a = s(n), v = this._rgba = [];
            return (f !== undefined && (n = [n, f, e, o], a = "array"), a === "string") ? this.parse(ot(n) || c._default) : a === "array" ? (r(u.rgba.props, function (t, i) {
                v[i.idx] = l(n[i.idx], i)
            }), this) : a === "object" ? (n instanceof t ? r(u, function (t, i) {
                n[i.cache] && (h[i.cache] = n[i.cache].slice())
            }) : r(u, function (t, u) {
                var f = u.cache;
                ...
                h[f] && i.inArray(null, h[f].slice(0, 3)) < 0 && (h[f][3] == null && (h[f][3] = 1), u.from && (h._rgba = u.from(h[f])))
            }), this) : void 0
        }, is: function (n) {
            var e = t(n), i = !0, f = this;
            ...
            var f = t(n), s = f._space(), e = u[s], h = this.alpha() === 0 ? t("transparent") : this,
                c = h[e.cache] || e.to(h._rgba), o = c.slice();
            return f = f[e.cache], r(e.props, function (n, t) {
                var s = t.idx, r = c[s], u = f[s], e = ut[t.type] || {};
                u !== null && (r === null ? o[s] = u : (e.mod && (u - r > e.mod / 2 ? r += e.mod : r - u > e.mod / 2 && (r -= e.mod)), o[s] = l((u - r) * i + r, t)))
            }), this[s](o)
        }, blend: function (n) {
            if (this._rgba[3] === 1) return this;
            var r = this._rgba.slice(), u = r.pop(), f = t(n)._rgba;
            return t(i.map(r, function (n, t) {
                return (1 - u) * f[t] + u * n
            }))
        }, toRgbaString: function () {
            var t = "rgba(", n = i.map(this._rgba, function (n, t) {
                return n != null ? n : t > 2 ? 1 : 0
            });
            return n[3] === 1 && (n.pop(), t = "rgb("), t + n.join() + ")"
        }, toHslaString: function () {
            var t = "hsla(", n = i.map(this.hsla(), function (n, t) {
                return n == null && (n = t > 2 ? 1 : 0), t && t < 3 && (n = Math.round(n * 100) + "%"), n
            });
            return n[3] === 1 && (n.pop(), t = "hsl("), t + n.join() + ")"
        }, toHexString: function (n) {
            var t = this._rgba.slice(), r = t.pop();
    ...
    r(u, function (n, i) {
        var f = i.props, u = i.cache, e = i.to, o = i.from;
        t.fn[n] = function (n) {
            if (e && !this[u] && (this[u] = e(this._rgba)), n === undefined) return this[u].slice();
            var h, c = s(n), a = c === "array" || c === "object" ? n : arguments, i = this[u].slice();
            return r(f, function (n, t) {
                var r = a[c === "object" ? n : t.idx];
                r == null && (r = i[t.idx]);
                i[t.idx] = l(r, t)
            }), o ? (h = t(o(i)), h[u] = i, h) : t(i)
        };
        r(f, function (i, r) {
            t.fn[i] || (t.fn[i] = function (t) {
                var u, f, e, h, o = s(t);
                return (h = i === "alpha" ? this._hsla ? "hsla" : "rgba" : n, u = this[h](), f = u[r.idx], o === "undefined") ? f : (o === "function" && (t = t.call(this, f), o = s(t)), t == null && r.empty) ? this : (o === "string" && (e = ur.exec(t), e && (t = f + parseFloat(e[2]) * (e[1] === "+" ? 1 : -1))), u[r.idx] = t, this[h](u))
            })
        })
    });
    t.hook = function (n) {
        ...
        r(u, function (n, r) {
            i.cssHooks[r] = {
                set: function (n, u) {
                    var o, f, e = "";
                    if (u !== "transparent" && (s(u) !== "string" || (o = ot(u)))) {
                        if (u = t(o || u), !ft.rgba && u._rgba[3] !== 1) {
                            for (f = r === "backgroundColor" ? n.parentNode : n; (e === "" || e === "transparent") && f && f.style;) try {
 ...
 * http://jquery.org/license
 */
    var a = "ui-effects-", p = "ui-effects-style", w = "ui-effects-animated";
    n.effects = {effect: {}}, function () {
        function f(n) {
        ...
        function t(n) {
            var i, r,
                t = n.ownerDocument.defaultView ? n.ownerDocument.defaultView.getComputedStyle(n, null) : n.currentStyle,
                u = {};
            if (t && t.length && t[0] && t[t[0]]) for (r = t.length; r--;) i = t[r], typeof t[i] == "string" && (u[f(i)] = t[i]); else for (i in t) typeof t[i] == "string" && (u[i] = t[i]);
            return u
        }
        ...
        function t(t, i, r, u) {
            return n.isPlainObject(t) && (i = t, t = t.effect), t = {effect: t}, i == null && (i = {}), typeof i == "function" && (u = i, r = null, i = {}), (typeof i == "number" || n.fx.speeds[i]) && (u = r, r = i, i = {}), typeof r == "function" && (u = r, r = null), i && n.extend(t, i), r = r || i.duration, t.duration = n.fx.off ? 0 : typeof r == "number" ? r : r in n.fx.speeds ? n.fx.speeds[r] : n.fx.speeds._default, t.complete = u || i.complete, t
        }
        ...
        n.uiBackCompat !== !1 && n.extend(n.effects, {
            save: function (n, t) {
                for (var i = 0, r = t.length; i < r; i++) t[i] !== null && n.data(a + t[i], n[0].style[t[i]])
            }, restore: function (n, t) {
                for (var r, i = 0, u = t.length; i < u; i++) t[i] !== null && (r = n.data(a + t[i]), n.css(t[i], r))
                ...
                return t.wrap(u), (t[0] === r || n.contains(t[0], r)) && n(r).trigger("focus"), u = t.parent(), t.css("position") === "static" ? (u.css({position: "relative"}), t.css({position: "relative"})) : (n.extend(i, {
                    position: t.css("position"),
        ...
        n.extend(n.effects, {
            version: "1.13.1", define: function (t, i, r) {
                ...
                var r = i !== "horizontal" ? (t || 100) / 100 : 1, u = i !== "vertical" ? (t || 100) / 100 : 1;
                return {
                    height: n.height() * u,
                    width: n.width() * r,
                ...
                return t.css({
                    ...
                    marginRight: t.css("marginRight"),
                    float: t.css("float")
                }).outerWidth(t.outerWidth()).outerHeight(t.outerHeight()).addClass("ui-effects-placeholder"), t.data(a + "placeholder", i)), t.css({
                    position: r,
                    left: u.left,
                    top: u.top
                }), i
            }, removePlaceholder: function (n) {
                var t = a + "placeholder", i = n.data(t);
        ...
        n.fn.extend({
            effect: function () {
                function l(t) {
                    ...
                    var o = n(this);
                    i.mode = h.shift();
                    n.uiBackCompat === !1 || u ? i.mode === "none" ? (o[r](), s()) : e.call(o[0], i, c) : (o.is(":hidden") ? r === "hide" : r === "show") ? (o[r](), s()) : e.call(o[0], i, s)
                }

                var i = t.apply(this, arguments), e = n.effects.effect[i.effect], u = e.mode, o = i.queue,
                    s = o || "fx", f = i.complete, r = i.mode, h = [], c = function (t) {
                ...
                var u = n(this), r = n(t.to), f = r.css("position") === "fixed", e = n("body"),
                    o = f ? e.scrollTop() : 0, s = f ? e.scrollLeft() : 0, h = r.offset(),
                    a = {top: h.top - o, left: h.left - s, height: r.innerHeight(), width: r.innerWidth()},
                    c = u.offset(), l = n("<div class='ui-effects-transfer'><\/div>");
 ...
 * http://jquery.org/license
 */
    er = n.effects.define("blind", "hide", function (t, i) {
        var e = {
                up: ["bottom", "top"],
                vertical: ["bottom", "top"],
                down: ["top", "bottom"],
                ...
                right: ["left", "right"]
            }, u = n(this), o = t.direction || "up", s = u.cssClip(), r = {clip: n.extend({}, s)},
 ...
 * http://jquery.org/license
 */
    or = n.effects.define("bounce", function (t, i) {
        var e, o, a, u = n(this), p = t.mode, s = p === "hide", w = p === "show", h = t.direction || "up",
            r = t.distance, v = t.times || 5, b = v * 2 + (w || s ? 1 : 0), c = t.duration / b, l = t.easing,
            f = h === "up" || h === "down" ? "top" : "left", y = h === "up" || h === "left", k = 0,
            d = u.queue().length;
        for (n.effects.createPlaceholder(u), a = u.css(f), r || (r = u[f === "top" ? "outerHeight" : "outerWidth"]() / 3), w && (o = {opacity: 1}, o[f] = a, u.css("opacity", 0).css(f, y ? -r * 2 : r * 2).animate(o, c, l)), s && (r = r / Math.pow(2, v - 1)), o = {}, o[f] = a; k < v; k++) e = {}, e[f] = (y ? "-=" : "+=") + r, u.animate(e, c, l).animate(o, c, l), r = s ? r * 2 : r / 2;
 ...
 * http://jquery.org/license
 */
    sr = n.effects.define("clip", "hide", function (t, i) {
        var r, u = {}, f = n(this), e = t.direction || "vertical", o = e === "both", s = o || e === "horizontal",
            h = o || e === "vertical";
        r = f.cssClip();
        u.clip = {
 ...
 * http://jquery.org/license
 */
    hr = n.effects.define("drop", "hide", function (t, i) {
        var e, u = n(this), h = t.mode, c = h === "show", f = t.direction || "left",
            o = f === "up" || f === "down" ? "top" : "left", s = f === "up" || f === "left" ? "-=" : "+=",
            l = s === "+=" ? "-=" : "+=", r = {opacity: 0};
 ...
 * http://jquery.org/license
 */
    cr = n.effects.define("explode", "hide", function (t, i) {
        function k() {
            p.push(this);
            p.length === e * c && d()
        }
        ...
        for (var u, l, a, v, y, e = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = e, o = n(this), b = t.mode, f = b === "show", w = o.show().css("visibility", "hidden").offset(), s = Math.ceil(o.outerWidth() / c), h = Math.ceil(o.outerHeight() / e), p = [], r = 0; r < e; r++) for (a = w.top + r * h, y = r - (e - 1) / 2, u = 0; u < c; u++) l = w.left + u * s, v = u - (c - 1) / 2, o.clone().appendTo("body").wrap("<div><\/div>").css({
            position: "absolute",
            visibility: "visible",
            left: -u * s,
            top: -r * h
 ...
 * http://jquery.org/license
 */
    lr = n.effects.define("fade", "toggle", function (t, i) {
        var r = t.mode === "show";
 ...
 * http://jquery.org/license
 */
    ar = n.effects.define("fold", "hide", function (t, i) {
        var u = n(this), l = t.mode, v = l === "show", y = l === "hide", o = t.size || 15, a = /([0-9]+)%/.exec(o),
            p = !!t.horizFirst, f = p ? ["right", "bottom"] : ["bottom", "right"], s = t.duration / 2,
            h = n.effects.createPlaceholder(u), e = u.cssClip(), c = {clip: n.extend({}, e)},
            r = {clip: n.extend({}, e)}, w = [e[f[0]], e[f[1]]], b = u.queue().length;
 ...
 * http://jquery.org/license
 */
    vr = n.effects.define("highlight", "show", function (t, i) {
 ...
 * http://jquery.org/license
 */
    yr = n.effects.define("size", function (t, i) {
        var l, r, p, u = n(this), v = ["fontSize"],
            s = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            h = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], w = t.mode, y = w !== "effect",
            c = t.scale || "both", b = t.origin || ["middle", "center"], k = u.css("position"), a = u.position(),
            o = n.effects.scaledDimensions(u), f = t.from || o, e = t.to || n.effects.scaledDimensions(u, 0);
        n.effects.createPlaceholder(u);
        w === "show" && (p = f, f = e, e = p);
 ...
 * http://jquery.org/license
 */
    pr = n.effects.define("scale", function (t, i) {
        var u = n(this), f = t.mode,
 ...
 * http://jquery.org/license
 */
    wr = n.effects.define("puff", "hide", function (t, i) {
 ...
 * http://jquery.org/license
 */
    br = n.effects.define("pulsate", "show", function (t, i) {
        var r = n(this), e = t.mode, o = e === "show", c = e === "hide", l = o || c,
            f = (t.times || 5) * 2 + (l ? 1 : 0), s = t.duration / f, u = 0, h = 1, a = r.queue().length;
 ...
 * http://jquery.org/license
 */
    kr = n.effects.define("shake", function (t, i) {
        var l = 1, r = n(this), f = t.direction || "left", e = t.distance || 20, a = t.times || 3, v = a * 2 + 1,
            u = Math.round(t.duration / v), o = f === "up" || f === "down" ? "top" : "left",
            s = f === "up" || f === "left", h = {}, c = {}, y = {}, p = r.queue().length;
 ...
 * http://jquery.org/license
 */
    dr = n.effects.define("slide", "show", function (t, i) {
        var s, o, u = n(this),
            h = {up: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], right: ["left", "right"]},
            c = t.mode, f = t.direction || "left", e = f === "up" || f === "down" ? "top" : "left",
            l = f === "up" || f === "left", a = t.distance || u[e === "top" ? "outerHeight" : "outerWidth"](!0), r = {};
        n.effects.createPlaceholder(u);
        s = u.cssClip();
        o = u.position()[e];
        r[e] = (l ? -1 : 1) * a + o;
 ...
 * http://jquery.org/license
 */
    n.uiBackCompat !== !1 && (b = n.effects.define("transfer", function (t, i) {
        n(this).transfer(t, i)
    }));
    gr = b
}), NTP = {
    ...
    isProduction: !1
}, i = 0; i < NTP.devHostNames.length; i++) if (NTP.actualHostname === NTP.devHostNames[i]) {
    NTP.environment = "Dev";
    NTP.PublicSiteHostName = "https://ntpdev.niehs.nih.gov";
    break
}
for (i = 0; i < NTP.testHostNames.length; i++) if (NTP.actualHostname === NTP.testHostNames[i]) {
    NTP.environment = "Test";
    NTP.PublicSiteHostName = "https://ntptest.niehs.nih.gov";
    break
}
for (i = 0; i < NTP.productionHostnames.length; i++) if (NTP.actualHostname === NTP.productionHostnames[i]) {
...
$(function () {
    $(NTP.printpage).attr("href", "#").click(function () {
        window.print()
    });
...
addthis_config = {ui_tabindex: 0, ui_508_compliant: !0};
String.prototype.includes || (String.prototype.includes = function () {
    "use strict";
    return String.prototype.indexOf.apply(this, arguments) !== -1
});
ntpExternalDisclaimer = "This link is to a non-NTP website. Links do not constitute endorsement by NTP of the linked website. Visitors to the linked website will be subject to the website privacy policies. These practices may be different than those of this NTP website.";
$(document).ready(function () {
    ...
    onFooterMobile = function () {
        Foundation.MediaQuery.is("small only") ? n() : t()
    };
    $(window).on("load changed.zf.mediaquery", onFooterMobile);
    $("#footer a.external, .footer-logos a").attr("title", ntpExternalDisclaimer)
});
$(document).ready(function () {
    $.get(NTP.PublicSiteHostName + "/inside.cfm", function (n) {
        var t;
        if (n != "") {
            t = $(n);
            $("#footer-ntp").after(t);
            var r = encodeURIComponent(window.location.href), i = $(t.find('a[href*="webforms"]')), u = i.attr("href");
            i.attr("href", u + "&webpage=" + r)
        }
    }, "html")
});
$(function () {
    function r(n) {
        $("#" + n + ".queryAutocomplete").autocomplete({
            source: function (t, i) {
                var r = $("#" + n + "").closest("form").attr("action");
                $.ajax({
                    dataType: "jsonp",
                    url: "//seek.niehs.nih.gov/texis/autocomplete.json",
                    data: {pr: "ntp", term: t.term},
                    success: function (n) {
                        i(n.completions)
                    }
                })
            }, minLength: 2, select: function (t, i) {
                $("#" + n + "").val(i.item.value).closest("form").submit()
            }
        })
    }

    for (var t, i = $("[id^=query]").filter(".queryAutocomplete"), n = 0; n < i.length; n++) t = $("[id^=query]").filter(".queryAutocomplete")[n].id, r(t)
});
$(document).ready(function () {
    var n = $(".usa-closed");
    $(".usa-accordion-button").on("click", function () {
        $(n).hasClass("usa-closed") ? ($(this).attr("aria-expanded", "true"), $(n).removeClass("usa-closed"), $(n).addClass("usa-open")) : ($(this).attr("aria-expanded", "false"), $(n).addClass("usa-closed"), $(n).removeClass("usa-open"))
    })
});