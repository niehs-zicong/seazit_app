    ...
    [1],
    {
        111: function(e, t, n) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.MultipleCurveBody = t.SingleCurveBody = t.Header = void 0);
            var i = (function() {
                    function e(e, t) {
            ...
            w.propTypes = { title: d.default.string.isRequired };
            var O = (function(e) {
                function t(e) {
                    r(this, t);
                    var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return (n.state = { mortalityCheck: !1 }), n;
                }
                return (
                    l(t, e),
                    i(t, [
                        {
                            key: '_renderDoseResponse',
                            value: function(e) {
                                return e.mortalityCheck
                        ...
                        },
                        {
                            key: 'render',
                            value: function() {
                                var e = this.state.mortalityCheck
                                    ? [this.props.readout_id].concat([
                                          'Mortality@120_' + this.props.protocol_id,
                                      ])
                                    : [this.props.readout_id];
                                this.state.mortalityCheck ? b.COLLAPSE_BY_CHEMICAL : b.NO_COLLAPSE;
                                return (
                                    (this.state.url = (0, b.getDoseResponsesUrl)(
            ...
            var C = (function(e) {
                function t(e) {
                    ...
                    return (n.state = { vizColumns: a, vizHeight: 350, mortalityCheck: !1 }), n;
                }
                return (
                    l(t, e),
                    i(t, [
                        ...
                        l(t, [
                            {
                                ...
                                value: function() {
                                    return u.default.createElement(
                                        ...
                                        '  tab. For assistance,',
                                        ' ',
                                        'email us (ntpwebrequest@niehs.nih.gov) or use our',
                                        ' ',
                                        u.default.createElement(
                                            'a',
                                            {
        ...
        137: function(e, t) {
            e.exports = {
                legendText: 'graph__legendText___3XO50',
                tooltip: 'graph__tooltip___jiryp',
                yellowbox: 'graph__yellowbox___2ICjO',
                red: 'graph__red___11VBI',
                yellow: 'graph__yellow___1grgd',
                green: 'graph__green___3DUtT',
                blue: 'graph__blue___1NegX',
            };
        },
        1373: function(e, t, n) {
            'use strict';
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.renderIntegrativeAnalyses = t.renderBmdByLab = t.renderDoseResponse = t.renderQualityControl = t.renderDatasets = void 0);
            var r = n(1374),
                o = a(r),
                l = n(1378),
                i = a(l),
                ...
                _ = n(9),
                m = function(e) {
                    return (0, _.insertIntoDom)(o.default, e);
                },
                h = function(e) {
                    return (0, _.insertIntoDom)(i.default, e);
                },
                y = function(e) {
                    return (0, _.insertIntoDom)(d.default, e);
                },
                b = function(e) {
                    return (0, _.insertIntoDom)(s.default, e);
                },
                v = function(e) {
                    return (0, _.insertIntoDom)(f.default, e);
                };
            (t.renderDatasets = m),
                (t.renderQualityControl = h),
                (t.renderDoseResponse = b),
                (t.renderBmdByLab = y),
                (t.renderIntegrativeAnalyses = v);
        },
        1374: function(e, t, n) {
            'use strict';
            function a(e) {
                    ...
                    function t(e) {
                        ...
                        return (
                            (n.state = {
                                ...
                                metadata: null,
                                showHelpText: !1,
                                chemList: k.CHEMLIST_80,
                                chemicalFilterBy: k.CHEMFILTER_CATEGORY,
                                chemicals: [],
                                categories: [],
                                assays: [],
                                readouts: [],
                                plotCollapse: k.NO_COLLAPSE,
                                vizColumns: a,
                                vizHeight: 350,
                                tabFlag: k.ConcentrationResponseTab,
                            }),
                            n
                        );
                    }
                        ...
                        i(t, [
                            {
                                ...
                                value: function() {
                                    (0, k.loadMetadata)(this);
                                },
                            },
                            {
                                key: 'renderNoSelection',
                                value: function() {
                                    return (0, k.renderNoSelected)({
            ...
            var i =
                ...
                E = (function(e) {
                    function t(e) {
                        ...
                        var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                        return (
                            (n.colorScale = p.scaleOrdinal(p.schemeCategory10)),
                            (n.state = {
                                data: [],
                                ...
                                value: function(e, t) {
                                    var n = this,
                                        a = c.default
                                            ...
                                            .reject(function(e) {
                                                return 'Mortality@120' == e.endpoint_name;
                                            })
                                            .map('key')
                                            .uniq()
                                            .value(),
                                        ...
                                        o = c.default
                                            ...
                                            .map(function(t) {
                                                return {
                                                    ...
                                                    mortality120dose_response: c.default.filter(
                                                        e.dose_response,
                                ...
                                value: function(e, t) {
                                    ...
                                    switch (t) {
                                        ...
                                        case g.NO_COLLAPSE:
                                            return this.colorScale.domain(
                                                c.default.map(
                                                    e[0].dose_response.concat(
                                                        e[0].mortality120dose_response
                                                    ),
                                                    'endpoint_name'
                                                )
                                            );
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    switch (t) {
                                        ...
                                        case g.COLLAPSE_BY_CHEMICAL:
                                            return e.preferred_name + '|' + e.casrn;
                                        case g.NO_COLLAPSE:
                                            return (
                                    ...
                                    if (e.length > 0) {
                                        ...
                                        return (
                                            ...
                                            n.hit_confidence < 0.5
                                                ? ' '
                                                : 'BMC:' +
                                                  (0, g.printFloat)(1e6 * Math.pow(10, n.pod_med)) +
                                                  ' µM'
                                        );
                                    }
                                },
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    c.default.each(e.dose_response, function(e) {
                                        ...
                                        c.default.each(e.mortality120dose_response, function(e) {
                                            return n.setDatasetKey(e, t);
                                        });
                                },
                            },
                                    ...
                                    if (void 0 !== this.refs[e.key]) {
                                                ...
                                                modeBarButtonsToAdd: [
                                                    {
                                                        ...
                                                        icon: v.default.Icons.camera,
                                                        click: function(e) {
                                                            v.default.downloadImage(e, {
                                                                format: 'svg',
                                                            });
                                                        },
                                                    },
                                        ...
                                        e.groupKeys.map(function(t) {
                                            var o = e.dose_response.filter(function(e) {
                                                ...
                                                l = e.mortality120dose_response.filter(function(e) {
                                                    return e.groupKey == t;
                                                }),
                                                i = c.default
                                                    .chain(o)
                                                    ...
                                                    .value();
                                            (n.state.labelsDict = []),
                                                e.substance_code_input_ids.map(function(r, l) {
                                                    var u = c.default
                                                        .chain(o)
                                                        .filter(function(e) {
                                                    ...
                                                    a.push({
                                                        ...
                                                        text:
                                                            ...
                                                            n.getTextLabels(u, e),
                                                        marker: {
                                                            color: n.getMarkerColor(t, 'responses'),
                                                        },
                                                        opacity: 0.8,
                                                    });
                                                }),
                                                c.default
                                                    ...
                                                    .map(function(e, t) {
                                                        var r = c.default
                                                            ...
                                                            .filter(function(t) {
                                                                return (
                                                                    t.substance_code_input_id == e
                                                                );
                                                            })
                                                            .sortBy('dose')
                                                            .value();
                                                        a.push({
                                                            x: c.default.map(r, 'dose'),
                                                            y: r.map(function(e) {
                                                                return (e.n_in / e.n) * 100;
                                                            }),
                                                            legendgroup: 'plot',
                                            ...
                                            this.props.collapse === g.NO_COLLAPSE &&
                                                r &&
                                                l.shapes.push({
                                                    type: 'line',
                                                    xref: 'paper',
                                            ...
                                            v.default.newPlot(this.refs[e.key], a, l, o);
                                    }
                                },
                            },
                            {
                                    ...
                                    if (this.state.error)
                                        return _.default.createElement(
                                            ...
                                            _.default.createElement(
                                                'p',
                                                null,
                                                _.default.createElement('b', null, this.state.error)
                                            )
                                        );
        ...
        1476: function(e, t) {
            e.exports = {
                'react-switch-checkbox': 'Switch__react-switch-checkbox___2tgED',
                'react-switch-label': 'Switch__react-switch-label___2IdRs',
                'react-switch-button': 'Switch__react-switch-button___15b5h',
                slider: 'Switch__slider___1-yi7',
                round: 'Switch__round___2_1jB',
                switch: 'Switch__switch___2q0Rq',
            };
        },
        1477: function(e, t, n) {
            'use strict';
                                        ...
                                        d.default.createElement(
                                            ...
                                            d.default.createElement(
                                                'label',
                                                {
                                                    'data-toggle': 'tooltip',
                                                    'data-title':
                                                        'One chart for each chemical + endpoint combination',
                                                },
                                                d.default.createElement('input', {
                                                    ...
                                                    value: h.NO_COLLAPSE,
                                                    checked: e.plotCollapse === h.NO_COLLAPSE,
                                                }),
                                                'Chemical + Endpoint'
                                            ),
                                            d.default.createElement(
                                            ...
                                            d.default.createElement(
                                                'label',
                                                {
                                                    htmlFor: h.COLLAPSE_BY_CHEMICAL,
                                                    'data-toggle': 'tooltip',
                                                    'data-title':
                                                        'One chart for each chemical (multiple endpoints on chart)',
                                                },
                                                d.default.createElement('input', {
                                                    type: 'radio',
                                                    name: 'plotCollapse',
                                                    id: h.COLLAPSE_BY_CHEMICAL,
                                                    onChange: this.handleCollapseChange,
                                                    value: h.COLLAPSE_BY_CHEMICAL,
                                                    checked:
                                                        e.plotCollapse === h.COLLAPSE_BY_CHEMICAL,
                                                }),
                                                'Chemical'
                                            ),
                                            d.default.createElement(
                                            ...
                                            d.default.createElement(
                                                'label',
                                                {
                                                    htmlFor: h.COLLAPSE_BY_READOUT,
                                                    'data-toggle': 'tooltip',
                                                    'data-title':
                                                        'One chart for each endpoint (multiple chemicals on chart)',
                                                },
                                                d.default.createElement('input', {
                                                    type: 'radio',
                                                    name: 'plotCollapse',
                                                    id: h.COLLAPSE_BY_READOUT,
                                                    onChange: this.handleCollapseChange,
                                                    value: h.COLLAPSE_BY_READOUT,
                                                    checked:
                                                        e.plotCollapse === h.COLLAPSE_BY_READOUT,
                                                }),
                                                'Endpoint'
                                            )
                                        ),
            ...
            (y.propTypes = {
                stateHolder: f.default.shape({
                    state: f.default.shape({ plotCollapse: f.default.string.isRequired })
                        .isRequired,
                }).isRequired,
            }),
                (t.default = y);
                    ...
                    function t(e) {
                        ...
                        return (
                            (n.state = {
                                ...
                                metadata: null,
                                showHelpText: !1,
                                chemList: x.CHEMLIST_80,
                                chemicalFilterBy: x.CHEMFILTER_CATEGORY,
                                chemicals: [],
                                categories: [],
                                selectivityCutoff: 0.5,
                                selectivityList: [
                                    { id: 1, name: 'dev tox', isChecked: !0, label: 'specific' },
                                    {
                                        id: 2,
                                        name: 'general tox',
                                        isChecked: !1,
                                    ...
                                    { id: 4, name: 'inactive', isChecked: !1, label: 'non-toxic' },
                                ],
                                selectedAxis: x.AXIS_LOG10,
                                assay: [],
                                readouts: [],
                                visualization: x.BMDVIZ_ACTIVITY,
                                tabFlag: x.BMCTab,
                            }),
                            n
                        );
                        ...
                        i(t, [
                            {
                                key: 'componentWillMount',
                                value: function() {
                                    (0, x.loadMetadata)(this);
                                },
                            },
                            {
                                key: 'renderNoSelection',
                                value: function() {
                                    return (0, x.renderNoSelected)({
                                ...
                                value: function() {
                                    ...
                                    return s.default.createElement(
                                        ...
                                        s.default.createElement(
                                            ...
                                            this.state.visualization === x.BMDVIZ_SELECTIVITY
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    value: p.BMDVIZ_ACTIVITY,
                                                    checked: e.visualization === p.BMDVIZ_ACTIVITY,
                                                }),
                                                'Activity'
                                            ),
                                            s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'visualization',
                                                    onChange: this.handleRadioChange,
                                                    value: p.BMDVIZ_SELECTIVITY,
                                                    checked:
                                                        e.visualization === p.BMDVIZ_SELECTIVITY,
                                                }),
                                                'Specificity'
                                            )
                                        )
        ...
        1481: function(e, t, n) {
            ...
            var i = (function() {
                ...
                y = function(e, t) {
                    ...
                    var n = function() {
                            new _.default(m.Header, m.SingleCurveBody, {
                    ...
                    return (
                        'pod_med' == t
                            ? ((a = e.med_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.med_pod_med))
                                  : '-'),
                              (r = e.min_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.min_pod_med))
                                  : ''),
                              (o = e.max_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.max_pod_med))
                                  : ''))
                            : ((a = e.mort_med_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.mort_med_pod_med))
                                  : '-'),
                              (r = e.mort_min_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.mort_min_pod_med))
                                  : ''),
                              (o = e.mort_max_pod_med
                                  ? (0, h.printFloat)(1e6 * Math.pow(10, e.mort_max_pod_med))
                                  : '')),
                        s.default.createElement(
                            'button',
                        ...
                        i(t, [
                            {
                                ...
                                value: function(e) {
                                    return s.default.createElement(
                                        ...
                                        s.default.createElement('td', null, y(e, 'pod_med')),
                                        s.default.createElement('td', null, y(e, 'mort_pod_med')),
                                        s.default.createElement('td', null, e.n_values)
                                    );
                                },
                            },
                            {
            ...
            (b.propTypes = { data: d.default.array.isRequired }), (t.default = b);
        },
        1482: function(e, t, n) {
            'use strict';
            function a(e) {
                        ...
                        i(t, [
                            {
                                ...
                                value: function(e) {
                                    return s.default.createElement(
                                        ...
                                        s.default.createElement('td', null, e.casrn),
                                        s.default.createElement('td', null, e.use_category1),
                                        s.default.createElement('td', null, e.malformation),
                                        s.default.createElement(
                                            'td',
                                            null,
                                            s.default.createElement(
                                                'ul',
                                                null,
                                                Array.isArray(e.combin_ontology)
                                                    ? e.combin_ontology.map(function(e, t) {
                                                          return s.default.createElement(
                                                              'li',
                                                              { key: 'index-' + t },
                                                              e
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                'ul',
                                                null,
                                                Array.isArray(e.combin_ontology_id)
                                                    ? e.combin_ontology_id.map(function(e, t) {
                                                          return s.default.createElement(
                                                              'li',
                                                              { key: t },
                                                              s.default.createElement(
                                                                  ...
                                                                  {
                                                                      href:
                                                                          'https://www.ebi.ac.uk/ols/ontologies/zp/terms?iri=http%3A%2F%2Fpurl.obolibrary.org%2Fobo%2F' +
                                                                          e
                                                                              .toString()
                                                                              .split(':')
                                                                              .join('_'),
                                        ...
                                        s.default.createElement(
                                            'td',
                                            null,
                                            (0, h.printFloat)(1e6 * Math.pow(10, e.mean_pod))
                                        ),
                                        s.default.createElement(
                                            'td',
                                            null,
                                            (0, h.printFloat)(e.mean_selectivity)
                                        ),
                                        s.default.createElement('td', null, e.n_values),
                                        s.default.createElement('td', null, y(e, 'mort_pod_med'))
                                    );
                        ...
                        function t(e) {
                            ...
                            return (
                                (n.state = {
                                    ...
                                    datasetLabName: [],
                                    url: null,
                                    ontologyType: B.integrative_Granular,
                                    ontologyGroup: [],
                                    chemicalFilterBy: B.CHEMFILTER_CATEGORY,
                                    categories: [],
                                    chemicals: [],
                                    readoutType: B.READOUT_TYPE_CATEGORY,
                                    readouts: [],
                                    visualization: B.INTVIZ_HEATMAP,
                                    heatmapDisplay: B.HEATMAP_ACTIVITY,
                                    tabFlag: B.IntegrativeAnalysesTab,
                                }),
                                n
                            );
                        }
                        return (
                            ...
                            i(t, [
                                            ...
                                            ? s.default.createElement(
                                                  ...
                                                  s.default.createElement(
                                                      ...
                                                      s.default.createElement(
                                                          ...
                                                          ' For comparisons of readout or endpoint-category via activity or BMC; the most sensitive (i.e., lowest BMC) is presented where multiple BMCs are available. Selection of ‘activity’ presents the activity result as a binary output (active or inactive). Selection of ‘BMC’ will present the activity results based on the BMC value. Clicking on individual cells shows the user the concentration-response curve. By clicking on the row or column label, the concentration-response curves for an entire row/column are displayed.'
                                                      ),
                                                      s.default.createElement(
                                                          'li',
                                                          null,
                                                          s.default.createElement('b', null, 'XXX:')
                                                      )
                                                  ),
                                                  s.default.createElement(
                                                      'p',
                                    ...
                                    value: function() {
                                        return s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                ' This heatmap is interactive. Click a cell to view individual dose-response curves associated with it.'
                                            )
                                        );
                                    },
                                },
                                {
                                    ...
                                    value: function() {
                                        var e = this;
                                        return this.state.metadataLoaded
                                            ? ((this.state.datasetLabName = d.default
                                                  .chain(this.state.protocol_data)
                                                  .filter(function(t) {
                                                      return e.state.assays.includes(
                                                          t.seazit_protocol_id.toString()
                                                      );
                                                  })
                                                  .map('protocol_name_plot')
                                                  .value()),
                                              (this.state.url = (0, B.getIntegrativeUrl)(
                                                  this.state.assays,
                                                  this.state.chemicals
                                              )),
                                              s.default.createElement(
        ...
        1557: function(e, t, n) {
            ...
            var i = (function() {
                ...
                E = function(e, t) {
                    var n = t.casrns,
                        ...
                        c = void 0;
                    switch (o) {
                        case g.READOUT_TYPE_READOUT:
                            (c = 'BMC distribution by readout'),
                                (i = s.default
                                    .chain(e)
                                    .filter(function(e) {
                                        return e.bmd > 0;
                                    ...
                                    .filter(function(e) {
                                        return s.default.includes(n, e.chemical_casrn);
                                    })
                                    .filter(function(e) {
                                        return s.default.includes(l, e.readout_id);
                                    })
                                    .groupBy('readout_id')
                                    .values()
                                    .map(function(e) {
                                        return {
                                            ...
                                            boxpoints: 'all',
                                            jitter: 0.35,
                                            name: e[0].readout_endpoint,
                                            pointpos: 0,
                                            type: 'box',
                                            y: s.default.map(e, 'bmd'),
                                        };
                                    })
                                    .value());
                            break;
                        case g.READOUT_TYPE_CATEGORY:
                            (c = 'BMC distribution by endpoint category'),
                                (i = s.default
                                    .chain(e)
                                    .filter(function(e) {
                                        return e.bmd > 0;
                                    ...
                                    .filter(function(e) {
                                        return s.default.includes(r, e.provider_category);
                                    })
                ...
                w = (function(e) {
                    function t(e) {
                        r(this, t);
                        var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                        return (n.state = { data: null, noDataSelected: !0 }), n;
                    }
                    return (
                        l(t, e),
                        i(t, [
                            {
                                ...
                                value: function(e) {
                                    var t = this,
                                        n = '/neurotox/api/' + e + '/bmcByLabResult/?format=tsv',
                                        a = function(e) {
                                            return {
                                                id: +e.id,
                                                bmd: +e.bmd,
                                                substance_id: +e.substance_id,
                                                chemical_casrn: e.chemical_casrn,
                                                chemical_name: e.chemical_name,
                                                provider_category:
                                                    e.protocol_provider + ': ' + e.readout_category,
                                                readout_endpoint: e.readout_endpoint,
                            ...
                            },
                            {
                                key: 'renderPlot',
                                value: function() {
                                    var e = E(this.state.data, this.props);
                                    if (
                                        (this.refs.plot && m.default.purge(this.refs.plot),
                                        (e.data.length > 0 && !0 === this.state.noDataSelected) ||
                                            (0 === e.data.length &&
                                                !1 === this.state.noDataSelected))
                                    )
                                        return void this.setState({
                                            noDataSelected: !this.state.noDataSelected,
                                        });
                                    e.data.length > 0 && this.renderPlotly(e.data, e.layout);
                                },
                            },
                            {
                                key: 'componentWillMount',
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    return (
                                        e.bmdType !== this.props.bmdType &&
                                            this._updateData(e.bmdType),
                                        !0
                                    );
                                },
                            },
                            {
                                key: 'render',
                                value: function() {
                                    return this.state.noDataSelected
                                        ? (0, g.renderNoDataAlert)()
            ...
            (w.propTypes = {
                casrns: f.default.array.isRequired,
                readouts: f.default.array.isRequired,
                readoutType: f.default.number.isRequired,
                bmdType: f.default.string.isRequired,
                readoutCategories: f.default.array.isRequired,
            }),
                (t.default = w);
        },
        1558: function(e, t, n) {
                        ...
                        l(t, [
                            {
                                key: '_getUrl',
                                value: function(e) {
                                    return '/neurotox/api/' + e + '/pca_assay/?format=json';
                                },
                            },
                        ]),
                        t
        ...
        1559: function(e, t, n) {
                    ...
                    function t(e) {
                        ...
                        return (
                            (n._exportCsv = function(e) {
                                ...
                                var r = 'data:text/csv;charset=utf-8,' + a,
                                    o = document.createElement('a');
                                o.setAttribute('href', r),
                                    o.setAttribute('download', 'IntegrativeAnalysesData.csv'),
                                    o.click();
                            }),
                            (n.state = {
                                data: null,
                                ...
                                INTVIZ_HEATMAP_COLORS: [
                                    { key: 'dev tox', label: 'specific', fill: '#d62976' },
                                    { key: 'general tox', label: 'non-specific', fill: '#f9d70b' },
                                    {
                                        key: 'inconclusive',
                                        label: ' inconclusive, more tests are needed',
                                        fill: '#3BD6C6',
                                    },
                                    { key: 'inactive', label: 'non-toxic ', fill: '#FFFFFF' },
                                    { key: 'default', label: 'not evaluated', fill: '#C9C9C9' },
                                ],
                            }),
                            n
                        );
                        ...
                        i(t, [
                                    ...
                                    f.json(e, function(e, n) {
                                        ...
                                        var r = [1e-5, 1e3],
                                            o = f
                                                ...
                                                .range([1, 0]),
                                            l = function(e) {
                                                return f.interpolateViridis(o(e));
                                            };
                                        t.setState({ data: n, scale: o, continuousColorScale: l });
                                    });
                                },
                            },
                            {
                                ...
                                value: function() {
                                    var e = (function(e, t, n) {
                                            switch (e) {
                                                case b.INTVIZ_HEATMAP:
                                                    return function(e) {
                                                        ...
                                                        try {
                                                            for (
                                                                var o, l = n[Symbol.iterator]();
                                                                !(t = (o = l.next()).done);
                                                                t = !0
                                                            ) {
                                                                var i = o.value;
                                                                if (e.final_dev_call == i.key)
                                                                    return i.fill;
                                                            }
                                                        } catch (e) {
                                                            (a = !0), (r = e);
                                                ...
                                                case b.INTVIZ_DevtoxHEATMAP:
                                                    return function(e) {
                                                        switch (e.final_dev_call) {
                                                            case 'dev tox':
                                                                return e.mean_pod
                                                                    ? t(
                                                                          1e6 *
                                        ...
                                        t = (function(e, t, n, a) {
                                            switch (e) {
                                                case b.INTVIZ_HEATMAP:
                                                    return { type: 'discrete', values: a };
                                                case b.INTVIZ_DevtoxHEATMAP:
                                                    return {
                                                        type: 'continuous',
                                                        legendScale: t,
                                                        colorScaleFunction: n,
                                                    };
                                                default:
                                                    throw 'Unknown display type.';
                                            }
                                        ...
                                        n = this.state.data.integrative_activity_selectivity,
                                        a = this.props.ontologyGroup,
                                        r = ['dev tox', 'general tox', 'inconclusive', 'inactive'],
                                        o =
                                            this.props.ontologyType == b.integrative_Granular
                                                ? 'developmental_defect_grouping_granular'
                                                : 'developmental_defect_grouping_general';
                                    n = m.default
                                        .chain(n)
                                        .filter(function(e) {
                                            return a.includes(e[o]);
                                        })
                                        .map(function(e) {
                                            return {
                                                protocol_id: e.protocol_id,
                                                ...
                                                use_category1: e.use_category1,
                                                dtxsid: e.dtxsid,
                                                min_pod_med: e.min_pod_med,
                                                med_pod_med: e.med_pod_med,
                                                max_pod_med: e.max_pod_med,
                                                med_hitconf: e.med_hitconf,
                                                n_values: e.n_values,
                                                mort_min_pod_med: e.mort_min_pod_med,
                                                mort_med_pod_med: e.mort_med_pod_med,
                                                mort_max_pod_med: e.mort_max_pod_med,
                                                mort_med_hitconf: e.mort_med_hitconf,
                                                mort_n_values: e.mort_n_values,
                                                min_lowest_conc: e.min_lowest_conc,
                                                max_highest_conc: e.max_highest_conc,
                                                mean_pod: e.mean_pod,
                                                mean_selectivity: e.mean_selectivity,
                                                med_mort_hit_confidence: e.med_mort_hit_confidence,
                                                n_rep_max_dev_call: e.n_rep_max_dev_call,
                                                n_rep: e.n_rep,
                                                f_max_dev_call: e.f_max_dev_call,
                                                final_dev_call: e.final_dev_call,
                                                malformation: e.malformation,
                                                endpoint_name_protocol: e.endpoint_name_protocol,
                                                combin_ontology: e.combin_ontology,
                                                combin_ontology_id: e.combin_ontology_id,
                                                ...
                                                proposed_ontology_label: e.proposed_ontology_label,
                                                ontology_id_number: e.ontology_id_number,
                                                recording_name: e.recording_name,
                                                developmental_defect_catergories:
                                                    e.developmental_defect_catergories,
                                                defects_mapped_to_body_region:
                                                    e.defects_mapped_to_body_region,
                                                developmental_defect_grouping_granular:
                                                    e.developmental_defect_grouping_granular,
                                                developmental_defect_grouping_general:
                                                    e.developmental_defect_grouping_general,
                                                seazit_recording_id: e.seazit_recording_id,
                                                x: e[o] + ': ' + e.protocol_name_plot,
                                                y: e.preferred_name,
                                                fill: null,
                                                fillFlag: !1,
                                                ontologyGroupName: e[o],
                                                title:
                                                    e[o] +
                                                    '+' +
                                                    e.protocol_name_plot +
                                        ...
                                        .sortBy('med_pod_med')
                                        .value();
                                    var l = this.props.ontologyGroup,
                                        i = this.props.datasetLabName,
                                        u = [];
                                        ...
                                        case b.INTVIZ_HEATMAP:
                                            ...
                                            try {
                                                for (
                                                    ...
                                                    try {
                                                        for (
                                                            var E, w = s[Symbol.iterator]();
                                                            !(y = (E = w.next()).done);
                                                            y = !0
                                                        ) {
                                                            var O = E.value;
                                                            !(function(t) {
                                                                var a = m.default.filter(n, {
                                                                        x: h,
                                                                        y: t,
                                                                    }),
                                                                    o = m.default
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this;
                                    if (!this.state.data)
                                        return s.default.createElement(y.default, null);
                                    var t = void 0;
                                    return (
                                        (t = this._getFilteredData()),
                                        0 === t.data.length
                                            ? (0, b.renderNoDataAlert)()
                                            : this.props.visualization == b.INTVIZ_HEATMAP
                                            ? s.default.createElement(
                                                  'div',
                                                  null,
                                                  s.default.createElement(
            ...
            (O.propTypes = {
                assays: d.default.array.isRequired,
                casrns: d.default.array.isRequired,
                ontologyType: d.default.number.isRequired,
                ontologyGroup: d.default.array.isRequired,
                visualization: d.default.number.isRequired,
                url: d.default.string.isRequired,
                datasetLabName: d.default.array.isRequired,
            }),
                (t.default = O);
        },
        1560: function(e, t, n) {
            ...
            var i = (function() {
                ...
                O = function(e, t, n) {
                    ...
                    var a = {
                        ...
                        o = function(e) {
                            E.html(
                                'Potency: ' +
                                    (0, w.printFloat)(1e6 * Math.pow(10, e.mean_pod)) +
                                    ' μM  \n\n                 Specificity: ' +
                                    (0, w.printFloat)(e.mean_selectivity)
                            )
                                .style('left', h.event.pageX - 400 + 'px')
                                .style('top', h.event.pageY - 300 + 'px')
                                .style('opacity', 1);
                        },
                        l = function(e) {
                            E.style('opacity', 0);
                        ...
                        u = h
                            ...
                            .keys()
                            .sort(),
                        c = 50 * i.length + a.axisLeft + a.left + a.right + a.legend,
                        d = 50 * u.length + a.axisTop + a.top + a.bottom,
                        p = d - (a.top + a.bottom + a.axisTop),
                        f = c - (a.left + a.right + a.axisLeft + a.legend),
                        _ = [0, 2],
                        m = h
                            .scaleSqrt()
                            .domain(_)
                        ...
                        y = h
                            .select(e)
                            .append('svg')
                            .attr('width', Math.max(1e3, c + a.left + a.right))
                            .attr('height', Math.max(1e3, d + a.left + a.right))
                            .append('g')
                        ...
                        x = h
                            ...
                            .domain(u)
                            .range([0, p]),
                        k = h.axisTop(C).tickSizeOuter(0),
                        T = h.axisLeft(x).tickSizeOuter(0);
                    O.append('g')
                        .attr(
                            'transform',
                            'translate(' + (a.left + a.axisLeft) + ', ' + (a.top + a.axisTop) + ')'
                        )
                        .attr('class', 'axis y')
                        .call(T)
                        .style('font-size', 15)
                    ...
                    M.append('rect')
                        .attr('x', C.range()[0])
                        .attr('y', x.range()[0])
                        .attr('width', C.range()[1])
                        .attr('height', x.range()[1])
                        ...
                        M.selectAll('path')
                            .data(
                                t.filter(function(e) {
                                    return 'dev tox' === e.final_dev_call;
                                })
                            )
                            .enter()
                            .append('g')
                            ...
                            .append('circle')
                            .attr('r', function(e) {
                                return m(Math.abs(e.mean_selectivity));
                            })
                            ...
                            .on('mousemove', o)
                            .on('mouseleave', l)
                            .on('click', w.integrativeHandleCellClick),
                        M.selectAll('path')
                            .data(
                                t.filter(function(e) {
                                    return (
                                        'dev tox' !== e.final_dev_call && null !== e.final_dev_call
                                    );
                                })
                            )
                            .enter()
                    ...
                    var S = y
                        .append('g')
                        .classed('legendLayer', !0)
                        .attr('transform', 'translate(' + (c - a.legend) + ',' + a.top + ')');
                    switch (n.type) {
                        case 'discrete':
                            S.selectAll('text')
                                .data(n.values)
                                .enter()
                                .append('text')
                                .attr('class', v.default.legendText)
                                .attr('x', 35)
                                .attr('y', function(e, t) {
                                    return 20 * t + a.axisTop + 10;
                                })
                                .text(function(e) {
                                    return e.label;
                                });
                            S.selectAll('path')
                                ...
                                .attr('transform', function(e, t) {
                                    return 'translate(15, ' + (20 * t + a.axisTop) + ')';
                                })
                                .style('stroke', 'black')
                                .style('stroke-width', '1');
                            break;
                        case 'continuous':
                            var P = n.colorScaleFunction,
                                L = n.legendScale,
                                A = S.append('defs')
                            ...
                            L.ticks().map(function(e, t) {
                                ...
                                S.append('rect')
                                    ...
                                    .style('stroke', 'black')
                                    .attr('transform', 'translate(20,' + (a.top + a.axisTop) + ')'),
                                S.append('g')
                                    .attr('class', 'axis y')
                                    .attr('transform', 'translate(50,' + (a.top + a.axisTop) + ')')
                                    .call(
                                        (0, g.getLog10AxisFunction)(
                                            h.axisRight,
                                            L.copy().range([300, 0])
                                        )
                                    ),
                                S.append('text')
                                    ...
                                    .attr('x', 0)
                                    .attr('y', 0)
                                    .attr('transform', 'translate(20, ' + (a.axisTop + 15) + ')')
                                ...
                                S.append('rect')
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(20,' + (a.top + a.axisTop + 300 + 40) + ')'
                                    )
                                    .attr('mask', 'url(#stripeMask)')
                                    .attr('fill', '#ccc'),
                                S.append('rect')
                ...
                C = (function(e) {
                    function t(e) {
                        r(this, t);
                        var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                        return (n.handleResize = n.handleResize.bind(n)), n;
                    }
                    return (
                        l(t, e),
                        i(t, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    void 0 !== this.refs.svg &&
                                        (this.unrenderPlot(),
                                        O(this.refs.svg, this.props.data, this.props.legendData),
            ...
            (C.propTypes = {
                data: f.default.arrayOf(
                    f.default.shape({
                        x: f.default.string,
                        y: f.default.string,
                        fill: f.default.string,
                        hover_text: f.default.string,
                    })
                ).isRequired,
                legendData: f.default.shape({
                    type: f.default.oneOf(['discrete', 'continuous']).isRequired,
                    values: f.default.arrayOf(
                        f.default.shape({
                            label: f.default.string,
                            fill: f.default.string,
                            chemical_casrn: f.default.string,
                            readout_id: f.default.number,
                            title: f.default.string,
                        })
                    ),
                    colorScaleFunction: f.default.func,
                    legendScale: f.default.func,
                }).isRequired,
            }),
                (t.default = C);
        },
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'heatmapDisplay',
                                                    onChange: this.handleRadioChange,
                                                    value: p.HEATMAP_ACTIVITY,
                                                    checked:
                                                        e.heatmapDisplay === p.HEATMAP_ACTIVITY,
                                                }),
                                                'Activity'
                                            ),
                                            s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    onChange: this.handleRadioChange,
                                                    value: p.HEATMAP_BMC,
                                                    checked: e.heatmapDisplay === p.HEATMAP_BMC,
                                                }),
                                                'BMC'
                                            )
                                        )
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'visualization',
                                                    onChange: this.handleRadioChange,
                                                    value: p.INTVIZ_HEATMAP,
                                                    checked: e.visualization === p.INTVIZ_HEATMAP,
                                                }),
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'visualization',
                                                    onChange: this.handleRadioChange,
                                                    value: p.INTVIZ_DevtoxHEATMAP,
                                                    checked:
                                                        e.visualization === p.INTVIZ_DevtoxHEATMAP,
                                                }),
                                                'Heatmap with BMC and specificity'
                                            )
                                        )
                                    );
                                },
                        ...
                        i(t, [
                            {
                                ...
                                value: function() {
                                    ...
                                    return s.default.createElement(
                                        'div',
                                        null,
                                        s.default.createElement('label', null, 'Select BMC model:'),
                                        s.default.createElement(
                                            'div',
                                            { className: 'radio' },
                                            s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    onChange: this.handleRadioChange,
                                                    value: p.BMD_CURVEP,
                                                    checked: e.bmdType === p.BMD_CURVEP,
                                                }),
                                                'CurveP'
                                            )
                                        )
        ...
        1564: function(e, t, n) {
                    ...
                    return (
                        ...
                        i(t, [
                                        ...
                                        p.default.createElement(
                                            ...
                                            p.default.createElement(
                                                ...
                                                p.default.createElement('input', {
                                                    ...
                                                    name: 'ontologyType',
                                                    onChange: this.handleRadioChange,
                                                    value: m.integrative_Granular,
                                                    checked:
                                                        e.ontologyType === m.integrative_Granular,
                                                }),
                                                'Granular'
                                            ),
                                            p.default.createElement(
                                            ...
                                            p.default.createElement(
                                                ...
                                                p.default.createElement('input', {
                                                    ...
                                                    name: 'ontologyType',
                                                    onChange: this.handleRadioChange,
                                                    value: m.integrative_General,
                                                    checked:
                                                        e.ontologyType === m.integrative_General,
                                                }),
                                                'General'
                                            )
                                        )
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = void 0;
                                    return e.ontologyType === m.integrative_Granular
                                        ? ((t = c.default
                                              .chain(e.Seazit_ontology)
                                              .map(function(e) {
                                                  return {
                                                      key: e.developmental_defect_grouping_granular,
                                                      label:
                                                          e.developmental_defect_grouping_granular,
                                                      developmental_defect_catergories:
                                                          e.developmental_defect_catergories,
                                                      ...
                                                      hour_post_fertilization:
                                                          e.hour_post_fertilization,
                                                      ontology_id_number: e.ontology_id_number,
                                                      proposed_ontology_label:
                                                          e.proposed_ontology_label,
                                                      protocol_source: e.protocol_source,
                                                      recording_name: e.recording_name,
                                                      seazit_recording_id: e.seazit_recording_id,
                                                  };
                                              ...
                                              .value()),
                                          0 === c.default.keys(t).length
                                              ? null
                                              : (0, m.renderSelectMultiOptgroupWidget)(
                                                    'ontologyGroup',
                                                    'Granular',
                                                    t,
                                                    e.ontologyGroup,
                                        ...
                                        : ((t = c.default
                                              ...
                                              .map(function(e) {
                                                  return {
                                                      key: e.developmental_defect_grouping_general,
                                                      label:
                                                          e.developmental_defect_grouping_general,
                                                      developmental_defect_catergories:
                                                          e.developmental_defect_catergories,
            ...
            (b.propTypes = { stateHolder: y.default.instanceOf(p.default.Component).isRequired }),
                (t.default = b);
        },
        1565: function(e, t, n) {
            'use strict';
            ...
            var i = (function() {
                ...
                y = (function(e) {
                    ...
                    return (
                        ...
                        i(t, [
                            {
                                key: '_renderReadoutGroupSelector',
                                value: function(e) {
                                    var t = s.default
                                        .chain(e.tbl_readouts)
                                        ...
                                        .sortBy('label')
                                        .value();
                                    return (0, h.renderSelectMultiWidget)(
                                        'readoutCategories',
                                        'endpoint category',
                                        t,
                                        e.readoutCategories,
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this.props.stateHolder.state;
                                    return this._renderReadoutGroupSelector(e);
                                },
                            },
                        ]),
                        t
            ...
            (y.propTypes = { stateHolder: f.default.instanceOf(d.default.Component).isRequired }),
                (t.default = y);
        },
        1566: function(e, t, n) {
            'use strict';
                                        ...
                                        s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'readoutType',
                                                    onChange: this.handleRadioChange,
                                                    value: p.READOUT_TYPE_CATEGORY,
                                                    checked:
                                                        e.readoutType === p.READOUT_TYPE_CATEGORY,
                                                }),
                                                'by Category'
                                            ),
                                            s.default.createElement(
                                            ...
                                            s.default.createElement(
                                                ...
                                                s.default.createElement('input', {
                                                    ...
                                                    name: 'readoutType',
                                                    onChange: this.handleRadioChange,
                                                    value: p.READOUT_TYPE_READOUT,
                                                    checked:
                                                        e.readoutType === p.READOUT_TYPE_READOUT,
                                                }),
                                                'by Readout'
                                            )
                                        )
        ...
        24: function(e, t, n) {
                ...
                _ = (function(e) {
                    function t(e) {
                        ...
                        return (
                            ...
                            (n.handleCheckboxInputChange = n.handleCheckboxInputChange.bind(n)),
                            (n.handleToggleChange = n.handleToggleChange.bind(n)),
                            n
                        );
                    }
                    return (
                        ...
                        i(t, [
                            ...
                            {
                                key: 'handleCheckboxInputChange',
                                value: function(e) {
                                    var t = e.target,
                                        n = t.name,
                                        a = t.checked,
                                        r = this.props.stateHolder.state.selectivityList;
                                    r.map(function(e) {
                                        e.name === n && (e.isChecked = a);
                                    }),
                                        this.props.stateHolder.setState(r);
                                },
                            },
                        ]),
                        t
            ...
            (_.propTypes = { stateHolder: f.default.instanceOf(d.default.Component).isRequired }),
                (t.default = _);
        },
        299: function(e, t, n) {
            'use strict';
                        ...
                        u(t, [
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    var a = void 0,
                                        ...
                                        l = void 0;
                                    return (
                                        t == g.COLLAPSE_WITH_Mortality120
                                            ? ((a = c.default
                                                  .chain(e.dose_response)
                                                  .reject(function(e) {
                                                      return 'Mortality@120' == e.endpoint_name;
                                              ...
                                              (o = c.default
                                                  ...
                                                  .map(function(t) {
                                                      return {
                                                          key: t,
                                                          groupKeys: r,
                                                          dose_response: c.default
                                                              .filter(e.dose_response, { key: t })
                                                              .concat(
                                                                  c.default.filter(
                                                                      e.dose_response,
                                                                      {
                                                  ...
                                                  .each(function(e, a) {
                                                      ...
                                                      (e.title = n.getPlotTitle(r, t)),
                                                          ...
                                                          (e.input_ids = c.default
                                                              ...
                                                              .uniq()
                                                              .value()),
                                                          (e.bmcoutput = e.bmcoutput.filter(
                                                              function(t) {
                                                                  return e.input_ids.includes(
                                                                      t.input_id
                                                                  );
                                                          ...
                                                          (e.substance_code_input_ids = c.default
                                                              .chain(
                                                                  e.dose_response.filter(function(
                                                                      t
                                                                  ) {
                                                                      return e.input_ids.includes(
                                                                          t.input_id
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    switch (t) {
                                        ...
                                        case g.COLLAPSE_BY_CHEMICAL:
                                        case g.COLLAPSE_WITH_Mortality120:
                                            return this.colorScale.domain(
                                                c.default.map(e[0].dose_response, 'endpoint_name')
                                            );
                                        case g.NO_COLLAPSE:
                                            ...
                                            (n.state.labelsDict = []),
                                                e.substance_code_input_ids.map(function(r, i) {
                                                    ...
                                                    if (
                                                        ...
                                                        n.props.collapse ===
                                                            g.COLLAPSE_WITH_Mortality120)
                                                    ) {
                                                        var s = e.dose_response.filter(function(e) {
                                                            return (
                                                                'Mortality@120' == e.endpoint_name
                                                            );
                                                        });
                                                        c.default
                                                            .chain(s)
        ...
        312: function(e, t, n) {
            ...
            var i = (function() {
                ...
                b = (function(e) {
                    ...
                    return (
                        ...
                        i(t, [
                            {
                                key: '_renderSingleDatasetSelector',
                                value: function(e) {
                                    var t = c.default
                                        ...
                                        .map(function(e) {
                                            return {
                                                ...
                                                description: e.protocol_name_plot,
                                        ...
                                        .value();
                                    return (0, y.renderSelectSingleWidget)(
                                        'assay',
                                        'dataset',
                                        t,
                                        e.assay,
                            ...
                            {
                                key: '_renderMultipleDatasetSelector',
                                value: function(e) {
                                    var t = c.default
                                        .chain(e.protocol_data)
                                        .map(function(e) {
                                        ...
                                        .sortBy('seazit_protocol_id')
                                        .value();
                                    return (0, y.renderSelectMultiWidget)(
                                        'assays',
                                        'dataset',
                                        t,
                                        e.assays,
                            ...
                            {
                                key: '_renderSingleEndpointSelector',
                                value: function(e) {
                                    var t = [e.assay],
                                        n = c.default
                                            ...
                                            .map(function(e) {
                                                return {
                                                    ...
                                                    description: e.endpoint_description,
                                                    protocol_name: e.protocol_name,
                                            ...
                                            .sortBy('label')
                                            .sortBy(function(e) {
                                                return 'MalformedAny+Mort@120' !== e.label;
                                            })
                                            .sortBy('category')
                                            .groupBy('category')
                                            .value();
                                    return 0 === c.default.keys(n).length
                                        ? null
                                        : ((n = Object.values(n)[0]),
                                          (0, y.renderSelectSingleWidget)(
                                              'readouts',
                                              'endpoint',
                                              n,
                                              e.readouts,
                            ...
                            {
                                key: '_renderMultipleEndpointSelector',
                                value: function(e) {
                                    var t = e.assays,
                                        n = c.default
                                            .chain(e.Seazit_ui_panel)
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this.props.stateHolder.state;
                                    switch (e.tabFlag) {
                                        case y.ConcentrationResponseTab:
                                            return p.default.createElement(
                                                'div',
                                                null,
                                                this._renderMultipleDatasetSelector(e),
                                                this._renderMultipleEndpointSelector(e)
                                            );
                                    }
                                    switch (e.tabFlag) {
                                        case y.BMCTab:
                                            return p.default.createElement(
                                                'div',
                                                null,
                                                this._renderSingleDatasetSelector(e),
                                                this._renderSingleEndpointSelector(e)
                                            );
                                    }
                                    switch (e.tabFlag) {
                                        case y.IntegrativeAnalysesTab:
                                            return p.default.createElement(
                                                'div',
                                                null,
                                                this._renderMultipleDatasetSelector(e)
            ...
            (b.propTypes = {
                stateHolder: _.default.instanceOf(p.default.Component).isRequired,
                hideViability: _.default.bool.isRequired,
                hideNonViability: _.default.bool.isRequired,
                multiAssaySelector: _.default.bool.isRequired,
                multiReadoutSelector: _.default.bool.isRequired,
            }),
                (t.default = b);
        },
        313: function(e, t, n) {
                    ...
                    function t(e) {
                        ...
                        return (
                            (n.data_exportToCSVFile = function(e) {
                                if (0 == e.length) return '';
                                var t = _.default.sortBy(e.bmd_activity_selectivity, 'med_pod_med'),
                                    n = [
                                        'preferred_name',
                                        'casrn',
                                        'use_category1',
                                    ...
                                    n.forEach(function(t, a) {
                                        switch ((a > 0 && a < n.length && (r += ','), t)) {
                                            ...
                                            case 'mort_max_pod_med':
                                                r +=
                                                    '"' +
                                                    (0, x.printFloat)(1e6 * Math.pow(10, e[t])) +
                                                    '"';
                                                break;
                                            default:
                                                r += 'undefined';
                    ...
                    return (
                        ...
                        i(t, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (!this.state.data)
                                        return s.default.createElement(b.default, null);
                                    var e =
                                            this.props.visualization === x.BMDVIZ_ACTIVITY
                                                ? 'activity'
                                                : 'selectivity',
                                        t =
                                            this.props.visualization === x.BMDVIZ_ACTIVITY
                                        ...
                                        n = void 0,
                                        a = void 0;
                                    if (this.props.visualization === x.BMDVIZ_ACTIVITY)
                                        (n = _.default
                                            .chain(this.state.data.bmd_activity_selectivity)
                                            .map(function(e) {
                                                return {
                                                    casrn: e.casrn,
                                                    combin_ontology: e.combin_ontology,
                                        ...
                                        var r = _.default
                                            .chain(this.props.selectivityList)
                                            .filter(function(e) {
                                        ...
                                        (n = _.default
                                            .chain(this.state.data.bmd_activity_selectivity)
                                            .filter(function(e) {
                                                return r.includes(e.final_dev_call);
                                            })
                                            .map(function(e) {
                                                return {
                                                    casrn: e.casrn,
                                    ...
                                    return (
                                        ...
                                        s.default.createElement(
                                            ...
                                            this.props.visualization === x.BMDVIZ_ACTIVITY
                                                ? s.default.createElement(g.default, { data: a })
                                                : s.default.createElement(w.default, { data: a })
                                        )
                                    );
                                },
                            },
            ...
            (k.propTypes = {
                ...
                selectivityList: p.default.array.isRequired,
            ...
            var i = (function() {
                ...
                y = (function(e) {
                    ...
                    return (
                        ...
                        i(t, [
                            {
                                key: 'handleChemlistChange',
                                value: function(e) {
                                    var t = {},
                                        n = this.props.stateHolder.state,
                                        a = parseInt(e.target.value);
                                    (t[e.target.name] = a),
                                        (t.chemicals = this._getSelectedChemicals(
                                            n.tbl_substances,
                                            n.categories,
                                            a
                                        )),
                                        ...
                                        f.default.createElement(
                                            ...
                                            f.default.createElement(
                                                ...
                                                f.default.createElement('input', {
                                                    ...
                                                    onChange: this.handleRadioChange,
                                                    value: h.CHEMFILTER_CATEGORY,
                                                    checked:
                                                        e.chemicalFilterBy ===
                                                        h.CHEMFILTER_CATEGORY,
                                                }),
                                                'Category'
                                            ),
                                            f.default.createElement(
                                            ...
                                            f.default.createElement(
                                                ...
                                                f.default.createElement('input', {
                                                    ...
                                                    name: 'chemicalFilterBy',
                                                    onChange: this.handleRadioChange,
                                                    value: h.CHEMFILTER_CHEMICIAL,
                                                    checked:
                                                        e.chemicalFilterBy ===
                                                        h.CHEMFILTER_CHEMICIAL,
                                                }),
                                                'Name'
                                            )
                                        )
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = void 0;
                                    return e.chemicalFilterBy === h.CHEMFILTER_CHEMICIAL
                                        ? ((t = d.default
                                              ...
                                              .groupBy('category')
                                              .value()),
                                          (0, h.renderSelectMultiOptgroupWidget)(
                                              'chemicals',
                                              'chemical',
                                              t,
                                              e.chemicals,
                            ...
                            i(t, [
                                {
                                    ...
                                    value: function() {
                                        var e = this,
                                            t = this.props.stateHolder.state;
                                        return s.default.createElement(
                                            'div',
                                            null,
                                            s.default.createElement(
                                            ...
                                            t.selectivityList.map(function(t, n) {
                                                return s.default.createElement(
                                                    'div',
                                                    { className: 'checkbox', key: n },
                                                    s.default.createElement(
                                                        'label',
                                                        null,
                                                        s.default.createElement('input', {
                                                            ...
                                                            onChange: e.handleCheckboxInputChange,
                                                        }),
                                                        t.label
                                                    )
                                                );
        ...
        600: function(e, t, n) {
            ...
            var i = (function() {
                ...
                O = (a(w), n(329)),
                C = function(e, t, n) {
                    if (((0, f.default)(e).empty(), 0 === t.length))
                        return void (0, f.default)(e).append(
                    ...
                    var l = Math.max(Math.floor((0, f.default)(e).innerWidth()), 800),
                        ...
                        v = y.append('g').attr('transform', 'translate(160,0)');
                    v
                        ...
                        .attr('y1', function(e) {
                            return h(e.preferred_name) + h.bandwidth() / 2;
                        })
                        .attr('y2', function(e) {
                            return h(e.preferred_name) + h.bandwidth() / 2;
                        })
                        ...
                        v
                            ...
                            .attr('cx', function(e) {
                                return _(1e6 * Math.pow(10, e.med_pod_med));
                            })
                            .attr('cy', function(e) {
                                return h(e.preferred_name) + h.bandwidth() / 2;
                            })
                        ...
                        v
                            ...
                            .attr('cx', function(e) {
                                return _(1e6 * Math.pow(10, e.mort_med_pod_med));
                            })
                            .attr('cy', function(e) {
                                return h(e.preferred_name) + h.bandwidth() / 2;
                            })
                        ...
                        n.isSelective &&
                            ...
                            y
                                ...
                                .style('font-family', 'sans-serif')
                                .text(function(e) {
                                    return e.med_mort_hit_confidence < 0.5
                                        ? '≥ ' + (0, b.printFloat)(e.mean_selectivity)
                                        : (0, b.printFloat)(e.mean_selectivity);
                                })
                                .each(function(e) {
                                    e.med_mort_hit_confidence < 0.5 &&
                                        m
                                            .select(this)
                                            .attr('x', l - i.right - i.left + 10)
                                            .append('tspan')
                        ...
                        y
                            ...
                            .style('fill', 'white'),
                        y.append('g').call(m.axisLeft(h));
                    var w =
                        n.selectedAxis === b.AXIS_LOG10
                            ? (0, O.getLog10AxisFunction)(m.axisTop, _)
                            : m.axisTop(_);
                    v.append('g').call(w),
                        v
                            .append('text')
                    ...
                    var x = d.default.values(b.CATEGORY_COLORS);
                    C.selectAll('.__')
                        .data([
                            { y: -8, sw: 4, da: '10, 0', color: x[0] },
                            { y: -2, sw: 4, da: '10, 0', color: x[9] },
                        ...
                        C.selectAll('.__')
                            .data([
                                { x: 12, r: 7, y: -8, color: x[0] },
                                { x: 25, r: 7, y: -2, color: x[9] },
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    C(this.refs.bmd_svg, e.data, {
                                        ...
                                        selectivityList: e.selectivityList === b.BMDVIZ_SELECTIVITY,
                                    });
                                },
                            },
                            {
                        ...
                        i(t, [
                            {
                                key: 'render',
                                value: function() {
                                    return s.default.createElement('div', { ref: 'plot' });
                                },
                            },
                            {
                                key: 'renderPlotly',
                                value: function(e, t) {
                                    this.refs.plot && this.refs.plot.children.length > 0
                                        ? d.default.update(this.refs.plot, e, t)
                                        : d.default.newPlot(this.refs.plot, e, t);
                                },
                            },
                            {
                                key: 'componentWillUnmount',
                                value: function() {
                                    d.default.purge(this.refs.plot);
                                },
                            },
                        ]),
                        t
                        ...
                        i(t, [
                            {
                                key: '_getUrl',
                                value: function(e) {
                                    return '/neurotox/api/' + e + '/pca_chemical/?format=json';
                                },
                            },
                            {
                                key: 'shouldComponentUpdate',
                                value: function(e, t) {
                                    var n = this,
                                        a = this._getUrl(e.bmdType);
                                    return (
                                        p.json(a, function(e) {
                                            c.default.purge(n.refs.plot),
                                                n.renderPlotly(e.data, e.layout);
                                        }),
                                        !1
                                    );
                                },
                            },
                            {
                                ...
                                value: function() {
                                    var e = this,
                                        t = this._getUrl(this.props.bmdType);
                                    p.json(t, function(t) {
                                        e.renderPlotly(t.data, t.layout);
                                    });
                                },
                            },
                        ]),
            ...
            var i = (function() {
                ...
                k = function(e, t, n) {
                    ...
                    var a = {
                        ...
                        r = function(e) {
                            var t = xMap[e],
                                n = m.default.map(t, 'y_key'),
                                a = [t[0].x_key];
                            new g.default(E.Header, E.MultipleCurveBody, {
                                title: e,
                                readout_ids: a,
                                casrns: n,
                            });
                        ...
                        i = function(e) {
                            e.endPointList &&
                                O.html(
                                    e.devtoxEndPointList.length +
                                        ' out of ' +
                                        e.endPointList.length +
                                        ' endpoints are significant'
                                )
                                    .style('left', y.event.pageX - 400 + 'px')
                                    .style('top', y.event.pageY - 300 + 'px')
                                    .style('opacity', 1);
                        },
                        u = function(e) {
                            O.style('opacity', 0);
                        ...
                        d = y
                            ...
                            .keys()
                            .sort(),
                        p = 50 * c.length + a.axisLeft + a.left + a.right + a.legend,
                        f = 50 * d.length + a.axisTop + a.top + a.bottom,
                        _ = f - (a.top + a.bottom + a.axisTop),
                        h = p - (a.left + a.right + a.axisLeft + a.legend),
                        b = y
                            .symbol()
                            .type(y.symbolSquare)
                            .size(2500),
                        v = y
                            .select(e)
                            .append('svg')
                            .attr('width', Math.max(1e3, p + a.left + a.right))
                            .attr('height', Math.max(1e3, f + a.left + a.right))
                            .append('g')
                            .attr('transform', 'translate(' + a.left + ',' + a.top + ')'),
                        O = y
                            .select(e)
                        ...
                        M = y
                            ...
                            .domain(d)
                            .range([0, _]),
                        S = y.axisTop(T).tickSizeOuter(0),
                        P = y.axisLeft(M).tickSizeOuter(0);
                    k
                        .append('g')
                        .attr(
                            'transform',
                    ...
                    L.append('rect')
                        .attr('x', T.range()[0])
                        .attr('y', M.range()[0])
                        .attr('width', T.range()[1])
                        .attr('height', M.range()[1])
                        .attr('mask', 'url(#stripeMask)')
                        .attr('fill', '#ccc'),
                        L.append('rect')
                            .attr('x', T.range()[0])
                    ...
                    var A = v
                        .append('g')
                        .classed('legendLayer', !0)
                        .attr('transform', 'translate(' + (p - a.legend) + ',' + a.top + ')');
                    switch (n.type) {
                        case 'discrete':
                            A.selectAll('text')
                                .data(n.values)
                                .enter()
                                .append('text')
                                .attr('class', C.default.legendText)
                                .attr('transform', function(e, t) {
                                    return 'translate(65, ' + (50 * t + a.axisTop + 15 + 50) + ')';
                                })
                                .text(function(e) {
                                    return e.label;
                                }),
                                A.append('text')
                                    ...
                                    .attr('y', 0)
                                    .attr('transform', function(e, t) {
                                        return 'translate(25, ' + (a.axisTop + 15) + ')';
                                    })
                            ...
                            A.selectAll('path')
                                ...
                                .attr('transform', function(e, t) {
                                    return 'translate(25, ' + (50 * t + a.axisTop + 50) + ')';
                                })
                                .style('stroke', 'black')
                                .style('stroke-width', '1');
                            break;
                        case 'continuous':
                            var j = n.colorScaleFunction,
                                R = n.legendScale,
                                I = A.append('defs')
                                    .append('linearGradient')
                                    .attr('id', 'gradient')
                            ...
                            R.ticks().map(function(e, t) {
                                ...
                                A.append('text')
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(15, ' + (a.top + a.axisTop - 10) + ')'
                                    )
                                    .text('BMC (µM)'),
                                A.append('text')
                                    .attr('class', C.default.legendText)
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(50,' + (a.top + a.axisTop + 200 + 25) + ')'
                                    )
                                ...
                                A.append('rect')
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(20,' + (a.top + a.axisTop + 200 + 10) + ')'
                                    )
                                    .attr('fill', 'white')
                                    .style('stroke', 'black')
                                    .style('stroke-width', '1'),
                                A.append('rect')
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(20,' + (a.top + a.axisTop + 200 + 40) + ')'
                                    )
                                    .attr('mask', 'url(#stripeMask)')
                                    .attr('fill', '#ccc'),
                                A.append('rect')
                                ...
                                A.append('text')
                                    ...
                                    .attr(
                                        'transform',
                                        'translate(50,' + (a.top + a.axisTop + 200 + 55) + ')'
                                    )
                                    .text('Not tested');
                    }
                },
                T = (function(e) {
                    function t(e) {
                        ...
                        var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                        return (
                            (n.state = { data: null }), (n.handleResize = n.handleResize.bind(n)), n
                        );
                    }
                    return (
                        l(t, e),
                        i(t, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    void 0 !== this.refs.svg &&
                                        (this.unrenderPlot(),
                                        k(this.refs.svg, this.props.data, this.props.legendData),
                                        window.addEventListener('resize', this.handleResize));
                                },
                            },
                            {
        ...
        809: function(e, t, n) {
            'use strict';
            (n(25).selection.prototype.moveToFront = function() {
        ...
        9: function(e, t, n) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.integrativeHandleCellClick = t.svg_download_form = t.data_exportToJsonFile = t.renderNoSelected = t.renderNoDataAlert = t.printFloat = t.insertIntoDom = t.renderSelectMultiOptgroupWidget = t.renderSelectSingleWidget = t.renderSelectMultiWidget = t.loadMetadata = t.getIntegrativeUrl = t.getBmdsUrl = t.getDoseResponsesUrl = t.URL_CHEMXLSX = t.SELECTIVITY_FOOTNOTE = t.READOUT_TYPE_CATEGORY = t.READOUT_TYPE_READOUT = t.BMDVIZ_SELECTIVITY = t.BMDVIZ_ACTIVITY = t.INTVIZ_HEATMAP = t.INTVIZ_DevtoxHEATMAP = t.HEATMAP_BMC = t.HEATMAP_ACTIVITY = t.NO_COLLAPSE = t.COLLAPSE_WITH_Mortality120 = t.COLLAPSE_BY_READOUT = t.COLLAPSE_BY_CHEMICAL = t.CHEMLIST_ALL = t.CHEMLIST_91 = t.CHEMLIST_80 = t.IntegrativeAnalysesTab = t.BMCTab = t.ConcentrationResponseTab = t.CHEMFILTER_CHEMICIAL = t.CHEMFILTER_CATEGORY = t.CATEGORY_COLORS = t.integrative_General = t.integrative_Granular = t.BMD_CW = t.BMD_HILL = t.BMD_CURVEP = t.AXIS_SQRT = t.AXIS_LOG10 = t.AXIS_LINEAR = void 0);
            var r = n(16),
                o = a(r),
                l = n(25),
                i = (function(e) {
                ...
                v = function(e) {
                    i.json('/seazit/api/seazit_metadata/metadata/?format=json', function(t) {
                        e.setState({
                            ...
                            Seazit_ontology: t.Seazit_ontology,
                        });
                    });
                },
                g = function(e) {
                    ...
                    a.setAttribute('href', n),
                        a.setAttribute('download', 'jsonData.json'),
                        a.click();
                },
                ...
                w = function(e, t, n, a, r) {
                    return s.default.createElement(
                        'div',
                        null,
                        s.default.createElement('label', null, 'Select one ', t, ':'),
                        s.default.createElement(
                            'select',
                            {
                                name: e,
                            ...
                            o.default.map(n, function(e, t) {
                                return s.default.createElement(
                                    ...
                                    e.map(function(e) {
                                        return s.default.createElement(
                                            'option',
                                            { title: e.description, key: e.key, value: e.key },
                                            e.label
                                        );
                                    })
                                );
                ...
                x = function(e, t, n) {
                    return 0 === e.length || 0 === t.length || 0 === n.length
                        ? null
                        : '/seazit/api/seazit_result/crResult/?format=json&protocol_ids=' +
                              e.join(',') +
                              '&readouts=' +
                              t.join(',') +
                              '&casrns=' +
                ...
                T = function(e, t) {
                    return 0 === e.length || 0 === t.length
                        ? null
                        : '/seazit/api/seazit_result/integrativeResult/?format=json&protocol_ids=' +
                              e.join(',') +
                              '&casrns=' +
                              t.join(',');
                },
                ...
                P = function(e) {
                    e.endPointList &&
                        (e.endPointList && e.endPointList.length > 1
                            ? new h.default(_.Header, _.MultipleCurveBody, {
                                  title: e.title,
                                  protocol_id: e.protocol_id,
                                  readout_ids: o.default.map(e.endPointList, function(t) {
            ...
            (t.AXIS_LINEAR = 1),
                ...
                (t.BMD_HILL = 2),
                (t.BMD_CW = y),
                (t.integrative_Granular = 1),
                (t.integrative_General = 2),
                (t.CATEGORY_COLORS = b),
                (t.CHEMFILTER_CATEGORY = 1),
                (t.CHEMFILTER_CHEMICIAL = 2),
                (t.ConcentrationResponseTab = 1),
                (t.BMCTab = 2),
                (t.IntegrativeAnalysesTab = 3),
                (t.CHEMLIST_80 = 1),
                (t.CHEMLIST_91 = 2),
                (t.CHEMLIST_ALL = 3),
                (t.COLLAPSE_BY_CHEMICAL = 'COLLAPSE_BY_CHEMICAL'),
                (t.COLLAPSE_BY_READOUT = 'COLLAPSE_BY_READOUT'),
                (t.COLLAPSE_WITH_Mortality120 = 'COLLAPSE_WITH_Mortality120'),
                ...
                (t.getDoseResponsesUrl = x),
                (t.getBmdsUrl = k),
                (t.getIntegrativeUrl = T),
                (t.loadMetadata = v),
                (t.renderSelectMultiWidget = E),
                (t.renderSelectSingleWidget = w),
                (t.renderSelectMultiOptgroupWidget = O),
                (t.insertIntoDom = C),
                (t.printFloat = M),
                (t.renderNoDataAlert = L),
                (t.renderNoSelected = A),
                (t.data_exportToJsonFile = g),
                (t.svg_download_form = S),
                (t.integrativeHandleCellClick = P);
        },
    },
    [604]
);
//# sourceMappingURL=main.e8f1c6a8b643809b6558.js.map
