    ...
    [1],
    {
        1210: function(e, t, n) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.renderBmdByLab = t.renderDoseResponse = t.renderQualityControl = void 0);
            var r = n(1211),
                l = a(r),
                o = n(1215),
                i = a(o),
                ...
                c = n(16),
                d = function(e) {
                    return (0, c.insertIntoDom)(l.default, e);
                },
                f = function(e) {
                    return (0, c.insertIntoDom)(s.default, e);
                },
                p = function(e) {
                    return (0, c.insertIntoDom)(i.default, e);
                };
            (t.renderQualityControl = d), (t.renderDoseResponse = p), (t.renderBmdByLab = f);
        },
        1211: function(e, t, n) {
            'use strict';
            function a(e) {
                    ...
                    function t(e) {
                        ...
                        return (
                            (n.state = {
                                ...
                                metadata: null,
                                showHelpText: !1,
                                chemList: w.CHEMLIST_80,
                                chemicalFilterBy: w.CHEMFILTER_CATEGORY,
                                chemicals: [],
                                categories: [],
                                selectivityCutoff: 0.5,
                                assay: '',
                                readouts: [],
                                visualization: w.BMDVIZ_ACTIVITY,
                            }),
                            n
                        );
                    }
                        ...
                        i(t, [
                            {
                                key: 'componentWillMount',
                                value: function() {
                                    (0, w.loadMetadata)(this);
                                },
                            },
                            {
                                key: 'renderNoSelection',
                                value: function() {
                                    return (0, w.renderNoSelected)({
                                    ...
                                    return this.state.metadataLoaded
                                        ? s.default.createElement(
                                              ...
                                              s.default.createElement(
                                                  ...
                                                  this.state.visualization === w.BMDVIZ_SELECTIVITY
                                                      ? s.default.createElement(E.default, {
                                                            stateHolder: this,
                                                        })
                                                      : null
            ...
            var i = (function() {
                ...
                b = function(e) {
                    ...
                    var t = function() {
                        ...
                        n = e.bmdl ? (0, _.printFloat)(e.bmdl) : 'NR',
                        a = e.bmdu ? (0, _.printFloat)(e.bmdu) : 'NR';
                    return s.default.createElement(
                        'button',
                        { className: 'btn btn-link', onClick: t, style: { textAlign: 'left' } },
                                ...
                                value: function(e) {
                                    return s.default.createElement(
                                        ...
                                        s.default.createElement(
                                            'td',
                                            null,
                                            b(e.minimimumNonViability)
                                        ),
                                        s.default.createElement('td', null, b(e.minimimumViability))
                                    );
                                },
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    var e = p.default.filter(this.props.data, function(e) {
                                            return e.minimumBmd <= 0;
                                        }),
                                        t = p.default
                        ...
                        u(t, [
                            {
                                ...
                                value: function(e, t) {
                                    var n = this,
                                        ...
                                        l = c.default
                                            ...
                                            .map(function(t) {
                                                return {
                                                    ...
                                                    curvep: c.default.filter(e.curvep, { key: t }),
                                                    hill: c.default.filter(e.hill, { key: t }),
                                                };
                                            })
                                            .each(function(e, a) {
                                                var r = e.dose_response[0];
                                                (e.title = n.getPlotTitle(r, t)),
                                                    (e.chemical_name = r.chemical_name),
                                        ...
                                        u = void 0;
                                    return (
                                        (o = c.default.map(e.dose_response, 'normalized_response')),
                                        o.push(0),
                                        (i = f.extent(o)),
                                        (u = 0.15 * (i[1] - i[0]) * 0.5),
                                        (i = [i[0] - u, i[1] + u]),
                                        { data: e, collapsedData: l, yrange: i, error: null }
                                    );
                                },
                            },
                            {
                                    ...
                                    switch (t) {
                                        case v.COLLAPSE_BY_READOUT:
                                            return this.colorScale.domain(
                                                c.default.map(e[0].hill, 'casrn')
                                            );
                                        case v.COLLAPSE_BY_CHEMICAL:
                                            return this.colorScale.domain(
                                                c.default.map(e[0].hill, 'readout_id')
                                            );
                                        case v.NO_COLLAPSE:
                                ...
                                value: function(e) {
                                    var t =
                                        arguments.length > 1 && void 0 !== arguments[1]
                                            ? arguments[1]
                                            : null;
                                    return this.props.collapse === v.NO_COLLAPSE
                                        ? g[t]
                                        : this.state.scale(e);
                                },
                            },
                            {
                                ...
                                value: function(e, t) {
                                    switch (t) {
                                        ...
                                        case v.COLLAPSE_BY_CHEMICAL:
                                            return e.chemical_name + ' (' + e.casrn + ')';
                                        case v.NO_COLLAPSE:
                                            return (
                                                e.chemical_name +
                                                ' (' +
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    switch (t) {
                                        case v.COLLAPSE_BY_READOUT:
                                            return e[0].chemical_name + ' (' + e[0].casrn + ')';
                                        case v.COLLAPSE_BY_CHEMICAL:
                                        case v.NO_COLLAPSE:
                                            return e[0].endpoint_name;
                                        default:
                                            throw 'Unknown collapse type.';
                                    }
                                },
                            },
                            {
                                ...
                                value: function(e, t) {
                                    switch (t) {
                                        case v.COLLAPSE_BY_READOUT:
                                            (e.key = e.readout_id), (e.groupKey = e.casrn);
                                            break;
                                        case v.COLLAPSE_BY_CHEMICAL:
                                            (e.key = e.casrn), (e.groupKey = e.readout_id);
                                            break;
                                        case v.NO_COLLAPSE:
                                            (e.key = e.readout_id + '|' + e.casrn),
                                                (e.groupKey = null);
                                            break;
                                        default:
                                            throw 'Unknown collapse type.';
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    c.default.each(e.dose_response, function(e) {
                                        ...
                                        c.default.each(e.curvep, function(e) {
                                            return n.setDatasetKey(e, t);
                                        }),
                                        c.default.each(e.hill, function(e) {
                                            return n.setDatasetKey(e, t);
                                        });
                                },
                            },
                                        ...
                                        modeBarButtonsToAdd: [
                                            {
                                                ...
                                                click: function(e) {
                                                    b.default.downloadImage(e, { format: 'svg' });
                                                },
                                            },
                                        ],
                                    };
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    if (void 0 !== this.refs[e.key]) {
                                        var a = f.extent(c.default.map(e.dose_response, 'conc')),
                                            r = null;
                                        (this.state.layout = {
                                            ...
                                            height:
                                                ...
                                                (this.props.height +
                                                    19 *
                                                        this.state.collapsedData[0].groupKeys
                                                            .length +
                                                    20),
                                        }),
                                            e.groupKeys.map(function(t) {
                                                n.state.responsesmarker += 1;
                                                var l = e.dose_response.filter(function(e) {
                                                    return e.groupKey == t;
                                                });
                                                n.state.plotData.push({
                                                    x: c.default.map(l, 'conc'),
                                                    y: c.default.map(l, 'normalized_response'),
                                                    legendgroup: 'plot',
                                                    mode: 'markers',
                                                    type: 'scatter',
                                                    name:
                                                        'responses ' +
                                                        n.getResponseLabels(l, n.props.collapse),
                                                    showlegend: !0,
                                                    marker: {
                                                        color: n.getMarkerColor(
                                                            t,
                                                            'responses' + n.state.responsesmarker
                                                        ),
                                                    },
                                                    opacity: 0.8,
                                                }),
                                                    n.state.plotData.push({
                                                        ...
                                                        marker: {
                                                            color: n.getMarkerColor(
                                                                t,
                                                                'responses' +
                                                                    n.state.responsesmarker
                                                            ),
                                                        },
                                                        opacity: 0.8,
                                                    }),
                                                    e.curvep.length > 0 &&
                                                        ((n.state.curvepmarker += 1),
                                                        e.curvep
                                                            .filter(function(e) {
                                                                return e.groupKey == t;
                                                            })
                                                ...
                                                (this.state.layout.annotations = [
                                                    {
                                                        ...
                                                        text:
                                                            '<b>BMCs</b><br>' +
                                                            this.state.annotations.join('<br>'),
                                                        showarrow: !1,
                                                    },
                                                ]),
                                            this.props.collapse === v.NO_COLLAPSE &&
                                                ...
                                                this.state.layout.shapes.push({
                                                    ...
                                                    x1: a[1],
                                                    y1: 1 + r,
                                                    line: { color: 'grey', width: 4, dash: 'dot' },
                                                }),
                                            this.props.collapse !== v.NO_COLLAPSE &&
                                                ((this.state.layout.legend = {
                                                    orientation: 'h',
                                                    y: -0.5,
                                                }),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.state.collapsedData.map(function(t) {
                                        return e._renderLoadData(t, e.state.yrange);
                                    });
                                },
                            },
                            {
            ...
            var i = (function() {
                ...
                w = function(e, t, n) {
                    ...
                    var a = d.default
                            ...
                            .map(function(e) {
                                return (
                                    e.minimimumNonViability &&
                                    Object.assign({}, e.minimimumNonViability, {
                                        maximumSelectivity: e.maximumSelectivity,
                                    })
                                );
                            })
                            .compact()
                        ...
                        r = d.default
                            ...
                            .compact()
                            .value(),
                        l = Math.max(Math.floor((0, p.default)(e).innerWidth()), 800),
                        o = { top: 40, right: 100, bottom: 25, left: 300 },
                        i = l - o.left - o.right,
                        u = 20 * t.length + 100 - o.top - o.bottom,
                        s = void 0,
                        c = m.extent(
                            d.default.compact(
                                d.default.flattenDeep([
                                    d.default.map(a, function(e) {
                                        return [e.bmd, e.bmdl, e.bmdu];
                                    }),
                        ...
                        h = m
                            ...
                            .domain(
                                t.map(function(e) {
                                    return e.chemical_name;
                                })
                            ),
                        y = function(e) {
                            var t = a.concat(r).filter(function(t) {
                                return (
                                    t.chemical_casrn == e.chemical_casrn &&
                                    t.readout_id != e.readout_id
                                );
                            });
                            if (0 == t.length) {
                                var n = {};
                                (n.readout_id = 0), t.push(n);
                            }
                            new g.default(E.Header, E.ParrallelCurveBody, {
                                title:
                                    e.chemical_name +
                                    ' (' +
                                    e.chemical_casrn +
                                    '): ' +
                                    e.readout_endpoint,
                                readout_id: [e.readout_id, t[0].readout_id],
                                casrn: e.chemical_casrn,
                            });
                        },
                        _ = m
                            .select(e)
                            .append('svg')
                            .attr('width', i + o.left + o.right)
                            .attr('height', u + o.top + o.bottom)
                            .append('g')
                            .attr('transform', 'translate(' + o.left + ',' + o.top + ')'),
                        v = _.append('g').attr('transform', 'translate(160,0)');
                    v
                        .selectAll('.nonviability-errorbar')
                        .data(a)
                        .enter()
                        .append('line')
                        .attr('class', 'nonviability-errorbar')
                        .attr('x1', function(e) {
                            return f(m.min([e.bmdl, e.bmd]));
                        })
                        .attr('x2', function(e) {
                            return f(m.max([e.bmd, e.bmdu]));
                        })
                        .attr('y1', function(e) {
                            return h(e.chemical_name) + h.bandwidth() / 2;
                        })
                        .attr('y2', function(e) {
                            return h(e.chemical_name) + h.bandwidth() / 2;
                        })
                        .style('stroke', function(e) {
                            return b.CATEGORY_COLORS[e.chemical_category];
                        })
                        ...
                        n.isSelective &&
                            ...
                            _.selectAll('.selectivity-text')
                                ...
                                .style('font-family', 'sans-serif')
                                .text(function(e) {
                                    return e.has_viability_bmd
                                        ? (0, b.printFloat)(e.maximumSelectivity)
                                        : '≥ ' + (0, b.printFloat)(e.maximumSelectivity);
                                })
                                .each(function(e) {
                                    e.has_viability_bmd ||
                        ...
                        _.selectAll('.category-text')
                            ...
                            .attr('dy', '0.35em')
                            .text(function(e) {
                                return e.chemical_category;
                            })
                            .style('fill', 'white'),
                        _.append('g').call(m.axisLeft(h));
                    var C =
                        n.selectedAxis === b.AXIS_LOG10
                            ? (0, O.getLog10AxisFunction)(m.axisTop, f)
                            : m.axisTop(f);
                    v.append('g').call(C),
                        v
                            .append('text')
                            .attr('transform', 'translate(' + (i - 160) / 2 + ', -25)')
                    ...
                    var S = d.default.values(b.CATEGORY_COLORS);
                    w
                        .selectAll('.__')
                        .data([
                            { y: -8, sw: 4, da: '10, 0', color: S[0] },
                            { y: -2, sw: 4, da: '10, 0', color: S[9] },
                        ...
                        w
                            .selectAll('.__')
                            .data([
                                { x: 12, r: 7, y: -8, color: S[0] },
                                { x: 25, r: 7, y: -2, color: S[9] },
        ...
        16: function(e, t, n) {
            ...
            var r = n(49),
                ...
                y = function(e, t, n, a, r) {
                    return s.default.createElement(
                        'div',
                        null,
                        s.default.createElement('label', null, 'Select an ', t, '(s):'),
                        s.default.createElement(
                            'select',
                            {
                                name: e,
            ...
            (t.AXIS_LINEAR = 1),
                ...
                (t.URL_CHEMXLSX = '/static/resources/seazit/NTP%20Chemical%20Library.xlsx'),
                (t.getDoseResponsesUrl = v),
                (t.getBmdsUrl = g),
                (t.loadMetadata = h),
                (t.renderSelectMultiWidget = m),
                (t.renderSelectSingleWidget = y),
                (t.renderSelectMultiOptgroupWidget = _),
                (t.insertIntoDom = b),
                (t.printFloat = E),
                (t.renderNoDataAlert = C),
                (t.renderNoSelected = O);
        },
        250: function(e, t, n) {
            'use strict';
            function a(e) {
                        ...
                        u(t, [
                            {
                                ...
                                value: function(e, t) {
                                    ...
                                    return (
                                        (o = [0, 100]),
                                        { data: e, collapsedData: l, yrange: o, error: null }
                                    );
                                },
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    f.json(e, function(e, n) {
                                        ...
                                        console.log(n), t.updateData(n, t.props.collapse);
                                    });
                                },
                            },
                            {
                                    ...
                                    if (e.length > 0) {
                                        ...
                                        return (
                                            ...
                                            n.hit_confidence < 0.5
                                                ? ' '
                                                : 'BMC:' +
                                                  (1e6 * Math.pow(10, n.pod_med)).toFixed(2) +
                                                  ' µM'
                                        );
                                    }
                                },
                                ...
                                value: function(e, t) {
                                    ...
                                    if (void 0 !== this.refs[e.key]) {
                                        ...
                                        e.groupKeys.map(function(t) {
                                            ...
                                            this.props.collapse !== v.NO_COLLAPSE &&
                                                (o.legend = { orientation: 'h', y: -0.3 }),
                                            b.default.newPlot(this.refs[e.key], a, o, l);
                                    }
                                },
                            },
                            {
        ...
        254: function(e, t, n) {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                (t.ParrallelCurveBody = t.MultipleCurveBody = t.SingleCurveBody = t.Header = void 0);
            var i = (function() {
                    function e(e, t) {
                        for (var n = 0; n < t.length; n++) {
                            var a = t[n];
            ...
            v.propTypes = { title: d.default.string.isRequired };
            var g = (function(e) {
                function t() {
                    return (
                        r(this, t),
            ...
            g.propTypes = {
                readout_id: d.default.number.isRequired,
            ...
            E.propTypes = {
                readout_id: d.default.array.isRequired,
                casrn: d.default.string.isRequired,
            };
            var C = (function(e) {
                function t(e) {
                    ...
                    var n = l(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)),
                        a = Math.max(1, Math.floor((0.75 * window.innerWidth) / 400));
                    return (n.state = { vizColumns: a, vizHeight: 350 }), n;
                }
                return (
                    o(t, e),
                    i(t, [
                            ...
                            value: function() {
                                ...
                                return s.default.createElement(
                                    ...
                                    s.default.createElement(
                                        'div',
                                        { className: 'col-sm-2' },
                                        s.default.createElement(_.default, { stateHolder: this })
                                    ),
                                    s.default.createElement(
                                        'div',
                                        { className: 'col-sm-10' },
        ...
        440: function(e, t, n) {
            ...
            var i,
                ...
                L = (function(e) {
                    ...
                    return (
                        ...
                        s(t, [
                            {
                                key: '_fetchDoseResponseData',
                                value: function(e) {
                                    var t = this;
                                    b.json(e, function(e, n) {
                                        if (e) {
                                            var a = e.target.responseText
                                                .replace('["', '')
                                                .replace('"]', '');
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    var t = this,
                                        n =
                                            '/seazit/api/seazit_cr_readout_result/bmds/?format=json&protocol_ids=1&readouts=Abnormal_heartbeat+Mort@120';
                                    console.log('url'),
                                        console.log(n),
                                        b.json(n, function(e, n) {
                                            if (e) {
                                                var a = e.target.responseText
                                                    .replace('["', '')
                                                    .replace('"]', '');
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this.props.selectedReadouts.map(function(e) {
                                            return parseInt(e);
                                        }),
                                        t = y.default.filter(this.state.data, function(t) {
                                            return y.default.includes(e, t.readout_id);
                                        }),
                                        n = y.default
                                            .chain(t)
                                            .map('protocol')
                                            .uniq()
                                            .value(),
                                        a = y.default.filter(this.state.data, function(e) {
                                            return (
                                                1 == e.readout_is_viability &&
                                                y.default.includes(n, e.protocol)
                                            );
                                        }),
                                        r = y.default.flattenDeep([a, t]),
                                        l = [
                                            'maximumSelectivity',
                                            'minimumBmd',
                                            'minimimumViability',
                                    ...
                                    return y.default
                                        ...
                                        .map(function(e) {
                                            var t = y.default.filter(e, function(e) {
                                                    return 1 == e.readout_is_viability;
                                                }),
                                                n = y.default.filter(e, function(e) {
                                                    return 0 == e.readout_is_viability;
                                                }),
                                                a = y.default
                                                    .chain(e)
                                                    .filter(function(e) {
                                                        return e.selectivity_ratio > 0;
                                                    })
                                                ...
                                                o = y.default
                                                    ...
                                                    .value();
                                            return {
                                                chemical_casrn: e[0].chemical_casrn,
                                                chemical_name: e[0].chemical_name,
                                                chemical_category: e[0].chemical_category,
                                                viables: t,
                                                nonViables: n,
                                                maximumSelectivity: a,
                                                minimumBmd: r,
                                                minimimumViability: l,
                                                minimimumNonViability: o,
                                            };
                                        })
                                        .each(function(e) {
                                            l.forEach(function(t) {
                                                y.default.isObject(e[t]) ||
                                                    isFinite(e[t]) ||
                                                    (e[t] = null);
                                            });
                                        })
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    var e = this,
                                        ...
                                        a = void 0;
                                    return (
                                        this.props.visualization === M.BMDVIZ_ACTIVITY
                                            ? ((n = function(e) {
                                                  return null !== e.minimumBmd;
                                              }),
                                              (a = 'minimumBmd'))
                                            : ((n = function(t) {
                                                  return (
                                                      null !== t.maximumSelectivity &&
                                                      t.maximumSelectivity >
                                                          e.props.selectivityCutoff
                                                  );
                                              }),
                                              (a = function(e) {
                                                  return -e.maximumSelectivity;
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    return (
                                        e.bmdType !== this.props.bmdType && this._updateData(e), !0
                                    );
                                },
                            },
                            {
                                    ...
                                    return d.default.createElement(
                                        ...
                                        d.default.createElement(
                                            ...
                                            d.default.createElement(
                                                ...
                                                {
                                                    onClick: function() {
                                                        return (0, M.data_exportToCSVFile)(
                                                            e._sortData(i),
                                                            l
                                                        );
                                                    },
                                            ...
                                            d.default.createElement(
                                                ...
                                                {
                                                    onClick: function() {
                                                        return (0, M.data_exportToJsonFile)(i);
                                                    },
                                                    class: 'btn btn-primary',
                                                },
                                                'Export data Json'
                                        ...
                                        this.props.visualization === M.BMDVIZ_ACTIVITY
                                            ? d.default.createElement(C.default, { data: r })
                                            : d.default.createElement(w.default, { data: r })
                                    );
                                },
                            },
                        ]),
            ...
            (L.propTypes = {
                visualization: h.default.number.isRequired,
                selectivityCutoff: h.default.number.isRequired,
            }),
                (t.default = L);
        },
        441: function(e, t, n) {
        ...
        646: function(e, t, n) {
            'use strict';
            (n(68).selection.prototype.moveToFront = function() {
...
//# sourceMappingURL=main.3362690cd49edd98cea0.js.map
