...
class IntegrativeAnalysesMain extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            datasetLabName: ['DRF_Lab A_SR-C', 'DRF_Lab B_S-DC', 'DRF_Lab C_S-C'],
            url:
                '/seazit/api/seazit_result/integrativeResult/?format=json&protocol_ids=1,2,3&casrns=13674-87-8,95-76-1',
            // ontologyWidget
